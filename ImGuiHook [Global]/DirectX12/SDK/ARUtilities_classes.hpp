...
static_assert(sizeof(UARLiveLinkRetargetAsset) == 0x000098, "Wrong size on UARLiveLinkRetargetAsset");
...
static_assert(sizeof(AARPassthroughManager) == 0x000260, "Wrong size on AARPassthroughManager");
static_assert(offsetof(AARPassthroughManager, ARComponentClasses) == 0x000248, "Member 'AARPassthroughManager::ARComponentClasses' has a wrong offset!");
static_assert(offsetof(AARPassthroughManager, PassthroughUpdateComponent) == 0x000258, "Member 'AARPassthroughManager::PassthroughUpdateComponent' has a wrong offset!");
