...
{
public:
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x00A8(0x0024)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UActorSequencePlayer) == 0x0004C0, "Wrong size on UActorSequencePlayer");
