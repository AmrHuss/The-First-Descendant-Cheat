...
static_assert(alignof(RadialSlider_SetHandStartEndRatio) == 0x000004, "Wrong alignment on RadialSlider_SetHandStartEndRatio");
static_assert(sizeof(RadialSlider_SetHandStartEndRatio) == 0x000008, "Wrong size on RadialSlider_SetHandStartEndRatio");
