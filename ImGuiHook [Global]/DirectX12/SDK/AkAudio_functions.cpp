...
void UAkGameplayStatics::LoadBankAsyncByName(const class FString& BankName, const TDelegate<void(EAkResult Result)>& BankLoadedCallback)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "LoadBankAsyncByName");

	Params::AkGameplayStatics_LoadBankAsyncByName Parms{};
