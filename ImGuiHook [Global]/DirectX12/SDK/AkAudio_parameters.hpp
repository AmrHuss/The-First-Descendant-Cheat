...
// Function AkAudio.AkGameplayStatics.LoadBankAsyncByName
// 0x0020 (0x0020 - 0x0000)
struct AkGameplayStatics_LoadBankAsyncByName final
{
public:
	class FString                                 BankName;                                          // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void(EAkResult Result)>             BankLoadedCallback;                                // 0x0010(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AkGameplayStatics_LoadBankAsyncByName) == 0x000008, "Wrong alignment on AkGameplayStatics_LoadBankAsyncByName");
static_assert(sizeof(AkGameplayStatics_LoadBankAsyncByName) == 0x000020, "Wrong size on AkGameplayStatics_LoadBankAsyncByName");
static_assert(offsetof(AkGameplayStatics_LoadBankAsyncByName, BankName) == 0x000000, "Member 'AkGameplayStatics_LoadBankAsyncByName::BankName' has a wrong offset!");
static_assert(offsetof(AkGameplayStatics_LoadBankAsyncByName, BankLoadedCallback) == 0x000010, "Member 'AkGameplayStatics_LoadBankAsyncByName::BankLoadedCallback' has a wrong offset!");
...
public:
	...
	struct FVector                                Location;                                          // 0x0010(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               Orientation;                                       // 0x001C(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	class UPostEventAtLocationAsync*              ReturnValue;                                       // 0x0028(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
