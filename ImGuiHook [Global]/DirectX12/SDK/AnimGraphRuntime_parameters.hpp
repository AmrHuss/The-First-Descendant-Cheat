...
static_assert(sizeof(BlendSpaceLibrary_GetFilteredPosition) == 0x000020, "Wrong size on BlendSpaceLibrary_GetFilteredPosition");
...
static_assert(sizeof(BlendSpaceLibrary_GetPosition) == 0x000020, "Wrong size on BlendSpaceLibrary_GetPosition");
...
public:
	struct FBlendSpaceReference                   BlendSpace;                                        // 0x0000(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                NewPosition;                                       // 0x0010(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(BlendSpaceLibrary_SnapToPosition) == 0x000008, "Wrong alignment on BlendSpaceLibrary_SnapToPosition");
static_assert(sizeof(BlendSpaceLibrary_SnapToPosition) == 0x000020, "Wrong size on BlendSpaceLibrary_SnapToPosition");
...
static_assert(sizeof(BlendSpacePlayerLibrary_GetPosition) == 0x000020, "Wrong size on BlendSpacePlayerLibrary_GetPosition");
...
static_assert(sizeof(BlendSpacePlayerLibrary_SnapToPosition) == 0x000020, "Wrong size on BlendSpacePlayerLibrary_SnapToPosition");
...
static_assert(alignof(KismetAnimationLibrary_CalculateDirection) == 0x000004, "Wrong alignment on KismetAnimationLibrary_CalculateDirection");
static_assert(sizeof(KismetAnimationLibrary_CalculateDirection) == 0x00001C, "Wrong size on KismetAnimationLibrary_CalculateDirection");
...
static_assert(offsetof(KismetAnimationLibrary_CalculateDirection, BaseRotation) == 0x00000C, "Member 'KismetAnimationLibrary_CalculateDirection::BaseRotation' has a wrong offset!");
static_assert(offsetof(KismetAnimationLibrary_CalculateDirection, ReturnValue) == 0x000018, "Member 'KismetAnimationLibrary_CalculateDirection::ReturnValue' has a wrong offset!");
...
{
public:
	struct FTransform                             CurrentTransform;                                  // 0x0000(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
