...
{
public:
	struct FVector2D                              InHandStartEndRatio;                               // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AudioRadialSlider_SetHandStartEndRatio) == 0x000004, "Wrong alignment on AudioRadialSlider_SetHandStartEndRatio");
static_assert(sizeof(AudioRadialSlider_SetHandStartEndRatio) == 0x000008, "Wrong size on AudioRadialSlider_SetHandStartEndRatio");
...
{
public:
	struct FVector2D                              InOutputRange;                                     // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AudioRadialSlider_SetOutputRange) == 0x000004, "Wrong alignment on AudioRadialSlider_SetOutputRange");
static_assert(sizeof(AudioRadialSlider_SetOutputRange) == 0x000008, "Wrong size on AudioRadialSlider_SetOutputRange");
