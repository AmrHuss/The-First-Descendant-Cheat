...
static_assert(alignof(ABP_PreviewLevelShopEtc_C) == 0x000008, "Wrong alignment on ABP_PreviewLevelShopEtc_C");
static_assert(sizeof(ABP_PreviewLevelShopEtc_C) == 0x0002F8, "Wrong size on ABP_PreviewLevelShopEtc_C");
static_assert(offsetof(ABP_PreviewLevelShopEtc_C, UberGraphFrame) == 0x0002E8, "Member 'ABP_PreviewLevelShopEtc_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_PreviewLevelShopEtc_C, DefaultSceneRoot) == 0x0002F0, "Member 'ABP_PreviewLevelShopEtc_C::DefaultSceneRoot' has a wrong offset!");
