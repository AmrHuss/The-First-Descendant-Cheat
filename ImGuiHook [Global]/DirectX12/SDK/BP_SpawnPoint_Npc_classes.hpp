...
class ABP_SpawnPoint_Npc_C final : public AM1SpawnPointTransientNpc
{
public:
...
static_assert(sizeof(ABP_SpawnPoint_Npc_C) == 0x0002B0, "Wrong size on ABP_SpawnPoint_Npc_C");
