...
static_assert(sizeof(UBinkMediaPlayer) == 0x000100, "Wrong size on UBinkMediaPlayer");
...
static_assert(offsetof(UBinkMediaTexture, AddressX) == 0x0001C0, "Member 'UBinkMediaTexture::AddressX' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, AddressY) == 0x0001C1, "Member 'UBinkMediaTexture::AddressY' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, MediaPlayer) == 0x0001C8, "Member 'UBinkMediaTexture::MediaPlayer' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, PixelFormat) == 0x0001D0, "Member 'UBinkMediaTexture::PixelFormat' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, Tonemap) == 0x0001D1, "Member 'UBinkMediaTexture::Tonemap' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, OutputNits) == 0x0001D4, "Member 'UBinkMediaTexture::OutputNits' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, Alpha) == 0x0001D8, "Member 'UBinkMediaTexture::Alpha' has a wrong offset!");
static_assert(offsetof(UBinkMediaTexture, DecodeSRGB) == 0x0001DC, "Member 'UBinkMediaTexture::DecodeSRGB' has a wrong offset!");
