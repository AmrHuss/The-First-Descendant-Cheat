...
#include "BunnyCommonGauge_classes.hpp"
#include "BunnyCommonGauge_parameters.hpp"
...
void UBunnyCommonGauge_C::DoCalculation(struct FM1AbilityOpCalcParam& Param, struct FM1CalcDamageInfo& DamageInfo, struct FM1AbilityOpExecCalcOutput& Output) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BunnyCommonGauge_C", "DoCalculation");

	Params::BunnyCommonGauge_C_DoCalculation Parms{};
