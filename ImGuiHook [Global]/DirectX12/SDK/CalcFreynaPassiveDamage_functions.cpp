...
#include "CalcFreynaPassiveDamage_classes.hpp"
#include "CalcFreynaPassiveDamage_parameters.hpp"
...
void UCalcFreynaPassiveDamage_C::DoCalculation(struct FM1AbilityOpCalcParam& Param, struct FM1CalcDamageInfo& DamageInfo) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CalcFreynaPassiveDamage_C", "DoCalculation");

	Params::CalcFreynaPassiveDamage_C_DoCalculation Parms{};
