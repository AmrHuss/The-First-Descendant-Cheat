...
#include "CalcSkillDamagePC_New_parameters.hpp"
...
void UCalcSkillDamagePC_New_C::DoCalculation(struct FM1AbilityOpCalcParam& Param, struct FM1CalcDamageInfo& DamageInfo) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CalcSkillDamagePC_New_C", "DoCalculation");

	Params::CalcSkillDamagePC_New_C_DoCalculation Parms{};
