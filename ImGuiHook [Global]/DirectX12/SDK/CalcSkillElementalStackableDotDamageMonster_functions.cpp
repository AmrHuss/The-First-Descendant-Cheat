...
#include "CalcSkillElementalStackableDotDamageMonster_classes.hpp"
#include "CalcSkillElementalStackableDotDamageMonster_parameters.hpp"
...
void UCalcSkillElementalStackableDotDamageMonster_C::DoCalculation(struct FM1AbilityOpCalcParam& Param, struct FM1CalcDamageInfo& DamageInfo) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CalcSkillElementalStackableDotDamageMonster_C", "DoCalculation");

	Params::CalcSkillElementalStackableDotDamageMonster_C_DoCalculation Parms{};
