...
#include "CalcTargetHPRatioDamage_classes.hpp"
#include "CalcTargetHPRatioDamage_parameters.hpp"
...
void UCalcTargetHPRatioDamage_C::DoCalculation(struct FM1AbilityOpCalcParam& Param, struct FM1CalcDamageInfo& DamageInfo) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CalcTargetHPRatioDamage_C", "DoCalculation");

	Params::CalcTargetHPRatioDamage_C_DoCalculation Parms{};
