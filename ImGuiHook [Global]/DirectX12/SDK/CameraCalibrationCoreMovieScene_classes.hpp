...
public:
	...
	TSubclassOf<class ULensModel>                 LensModelClass;                                    // 0x0150(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneLensComponentSection) == 0x000160, "Wrong size on UMovieSceneLensComponentSection");
...
static_assert(offsetof(UMovieSceneLensComponentSection, LensModelClass) == 0x000150, "Member 'UMovieSceneLensComponentSection::LensModelClass' has a wrong offset!");
