...
static_assert(offsetof(ULensDistortionModelHandlerBase, CameraFilmback) == 0x000058, "Member 'ULensDistortionModelHandlerBase::CameraFilmback' has a wrong offset!");
...
static_assert(sizeof(UAnamorphicLensDistortionModelHandler) == 0x0000F0, "Wrong size on UAnamorphicLensDistortionModelHandler");
...
static_assert(sizeof(UCalibrationPointComponent) == 0x000570, "Wrong size on UCalibrationPointComponent");
static_assert(offsetof(UCalibrationPointComponent, SubPoints) == 0x000510, "Member 'UCalibrationPointComponent::SubPoints' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, bVisualizePointsInEditor) == 0x000560, "Member 'UCalibrationPointComponent::bVisualizePointsInEditor' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, PointVisualizationScale) == 0x000564, "Member 'UCalibrationPointComponent::PointVisualizationScale' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, VisualizationShape) == 0x000568, "Member 'UCalibrationPointComponent::VisualizationShape' has a wrong offset!");
...
static_assert(sizeof(ACameraCalibrationCheckerboard) == 0x0002A0, "Wrong size on ACameraCalibrationCheckerboard");
static_assert(offsetof(ACameraCalibrationCheckerboard, Root) == 0x000248, "Member 'ACameraCalibrationCheckerboard::Root' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, TopLeft) == 0x000250, "Member 'ACameraCalibrationCheckerboard::TopLeft' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, TopRight) == 0x000258, "Member 'ACameraCalibrationCheckerboard::TopRight' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, BottomLeft) == 0x000260, "Member 'ACameraCalibrationCheckerboard::BottomLeft' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, BottomRight) == 0x000268, "Member 'ACameraCalibrationCheckerboard::BottomRight' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, Center) == 0x000270, "Member 'ACameraCalibrationCheckerboard::Center' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, NumCornerRows) == 0x000278, "Member 'ACameraCalibrationCheckerboard::NumCornerRows' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, NumCornerCols) == 0x00027C, "Member 'ACameraCalibrationCheckerboard::NumCornerCols' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, SquareSideLength) == 0x000280, "Member 'ACameraCalibrationCheckerboard::SquareSideLength' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, Thickness) == 0x000284, "Member 'ACameraCalibrationCheckerboard::Thickness' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, CubeMesh) == 0x000288, "Member 'ACameraCalibrationCheckerboard::CubeMesh' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, OddCubeMaterial) == 0x000290, "Member 'ACameraCalibrationCheckerboard::OddCubeMaterial' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, EvenCubeMaterial) == 0x000298, "Member 'ACameraCalibrationCheckerboard::EvenCubeMaterial' has a wrong offset!");
...
static_assert(sizeof(ULensComponent) == 0x000240, "Wrong size on ULensComponent");
...
static_assert(offsetof(ULensComponent, bScaleOverscan) == 0x000130, "Member 'ULensComponent::bScaleOverscan' has a wrong offset!");
static_assert(offsetof(ULensComponent, OverscanMultiplier) == 0x000134, "Member 'ULensComponent::OverscanMultiplier' has a wrong offset!");
static_assert(offsetof(ULensComponent, FilmbackOverride) == 0x000138, "Member 'ULensComponent::FilmbackOverride' has a wrong offset!");
static_assert(offsetof(ULensComponent, CroppedFilmback) == 0x00013C, "Member 'ULensComponent::CroppedFilmback' has a wrong offset!");
static_assert(offsetof(ULensComponent, bApplyNodalOffsetOnTick) == 0x000148, "Member 'ULensComponent::bApplyNodalOffsetOnTick' has a wrong offset!");
static_assert(offsetof(ULensComponent, OriginalTrackedComponentTransform) == 0x000150, "Member 'ULensComponent::OriginalTrackedComponentTransform' has a wrong offset!");
static_assert(offsetof(ULensComponent, bIsDistortionSetup) == 0x000180, "Member 'ULensComponent::bIsDistortionSetup' has a wrong offset!");
static_assert(offsetof(ULensComponent, OriginalFocalLength) == 0x000184, "Member 'ULensComponent::OriginalFocalLength' has a wrong offset!");
static_assert(offsetof(ULensComponent, LastDistortionMID) == 0x000188, "Member 'ULensComponent::LastDistortionMID' has a wrong offset!");
static_assert(offsetof(ULensComponent, LastCameraComponent) == 0x000190, "Member 'ULensComponent::LastCameraComponent' has a wrong offset!");
static_assert(offsetof(ULensComponent, LensDistortionHandlerMap) == 0x000198, "Member 'ULensComponent::LensDistortionHandlerMap' has a wrong offset!");
static_assert(offsetof(ULensComponent, TrackedComponent) == 0x0001E8, "Member 'ULensComponent::TrackedComponent' has a wrong offset!");
static_assert(offsetof(ULensComponent, TrackedComponentName) == 0x0001F0, "Member 'ULensComponent::TrackedComponentName' has a wrong offset!");
...
static_assert(sizeof(ULensFile) == 0x0002A8, "Wrong size on ULensFile");
static_assert(offsetof(ULensFile, LensInfo) == 0x000030, "Member 'ULensFile::LensInfo' has a wrong offset!");
static_assert(offsetof(ULensFile, DataMode) == 0x000068, "Member 'ULensFile::DataMode' has a wrong offset!");
static_assert(offsetof(ULensFile, UserMetadata) == 0x000070, "Member 'ULensFile::UserMetadata' has a wrong offset!");
static_assert(offsetof(ULensFile, EncodersTable) == 0x0000C0, "Member 'ULensFile::EncodersTable' has a wrong offset!");
static_assert(offsetof(ULensFile, DistortionTable) == 0x0001C0, "Member 'ULensFile::DistortionTable' has a wrong offset!");
static_assert(offsetof(ULensFile, FocalLengthTable) == 0x0001E0, "Member 'ULensFile::FocalLengthTable' has a wrong offset!");
static_assert(offsetof(ULensFile, ImageCenterTable) == 0x000200, "Member 'ULensFile::ImageCenterTable' has a wrong offset!");
static_assert(offsetof(ULensFile, NodalOffsetTable) == 0x000220, "Member 'ULensFile::NodalOffsetTable' has a wrong offset!");
static_assert(offsetof(ULensFile, STMapTable) == 0x000240, "Member 'ULensFile::STMapTable' has a wrong offset!");
static_assert(offsetof(ULensFile, UndistortionDisplacementMapHolders) == 0x000270, "Member 'ULensFile::UndistortionDisplacementMapHolders' has a wrong offset!");
static_assert(offsetof(ULensFile, DistortionDisplacementMapHolders) == 0x000280, "Member 'ULensFile::DistortionDisplacementMapHolders' has a wrong offset!");
