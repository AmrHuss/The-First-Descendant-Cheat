...
{
public:
	struct FLensDistortionState                   State;                                             // 0x0000(0x0020)(Parm, NativeAccessSpecifierPublic)
};
static_assert(alignof(LensComponent_SetDistortionState) == 0x000008, "Wrong alignment on LensComponent_SetDistortionState");
static_assert(sizeof(LensComponent_SetDistortionState) == 0x000020, "Wrong size on LensComponent_SetDistortionState");
...
{
public:
	struct FLensDistortionState                   ReturnValue;                                       // 0x0000(0x0020)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(LensComponent_GetDistortionState) == 0x000008, "Wrong alignment on LensComponent_GetDistortionState");
static_assert(sizeof(LensComponent_GetDistortionState) == 0x000020, "Wrong size on LensComponent_GetDistortionState");
...
public:
	...
	class ULensDistortionModelHandlerBase*        InLensHandler;                                     // 0x0010(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
