...
{
public:
	struct FVector2D                              FxFy;                                              // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FIntPoint                              ImageDimensions;                                   // 0x0030(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLensInfo) == 0x000008, "Wrong alignment on FLensInfo");
static_assert(sizeof(FLensInfo) == 0x000038, "Wrong size on FLensInfo");
...
static_assert(offsetof(FLensInfo, ImageDimensions) == 0x000030, "Member 'FLensInfo::ImageDimensions' has a wrong offset!");
...
{
public:
	struct FVector2D                              PrincipalPoint;                                    // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FQuat                                  RotationOffset;                                    // 0x0010(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
