...
static_assert(sizeof(ACineCameraActor) == 0x000B50, "Wrong size on ACineCameraActor");
static_assert(offsetof(ACineCameraActor, LookatTrackingSettings) == 0x000AE0, "Member 'ACineCameraActor::LookatTrackingSettings' has a wrong offset!");
...
static_assert(offsetof(UCineCameraComponent, FilmbackSettings) == 0x000AE0, "Member 'UCineCameraComponent::FilmbackSettings' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, Filmback) == 0x000AEC, "Member 'UCineCameraComponent::Filmback' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, LensSettings) == 0x000AF8, "Member 'UCineCameraComponent::LensSettings' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, FocusSettings) == 0x000B18, "Member 'UCineCameraComponent::FocusSettings' has a wrong offset!");
