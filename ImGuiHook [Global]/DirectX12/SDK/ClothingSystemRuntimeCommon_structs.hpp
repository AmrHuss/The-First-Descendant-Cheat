...
public:
	...
	TArray<uint8>                                 ClothFabricData;                                   // 0x0128(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FClothLODDataCommon, ClothFabricData) == 0x000128, "Member 'FClothLODDataCommon::ClothFabricData' has a wrong offset!");
