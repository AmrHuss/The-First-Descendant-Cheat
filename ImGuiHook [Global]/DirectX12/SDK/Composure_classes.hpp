...
static_assert(sizeof(AComposurePipelineBaseActor) == 0x000260, "Wrong size on AComposurePipelineBaseActor");
static_assert(offsetof(AComposurePipelineBaseActor, bAutoRun) == 0x000248, "Member 'AComposurePipelineBaseActor::bAutoRun' has a wrong offset!");
static_assert(offsetof(AComposurePipelineBaseActor, bAutoRunChildElementsAndSelf) == 0x000249, "Member 'AComposurePipelineBaseActor::bAutoRunChildElementsAndSelf' has a wrong offset!");
...
static_assert(sizeof(ACompositingElement) == 0x000538, "Wrong size on ACompositingElement");
static_assert(offsetof(ACompositingElement, CompositingTarget) == 0x000268, "Member 'ACompositingElement::CompositingTarget' has a wrong offset!");
static_assert(offsetof(ACompositingElement, PostProcessProxy) == 0x000270, "Member 'ACompositingElement::PostProcessProxy' has a wrong offset!");
static_assert(offsetof(ACompositingElement, Inputs) == 0x000278, "Member 'ACompositingElement::Inputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, TransformPasses) == 0x000288, "Member 'ACompositingElement::TransformPasses' has a wrong offset!");
static_assert(offsetof(ACompositingElement, Outputs) == 0x000298, "Member 'ACompositingElement::Outputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, CameraSource) == 0x0002A8, "Member 'ACompositingElement::CameraSource' has a wrong offset!");
static_assert(offsetof(ACompositingElement, TargetCameraActor) == 0x0002AC, "Member 'ACompositingElement::TargetCameraActor' has a wrong offset!");
static_assert(offsetof(ACompositingElement, ResolutionSource) == 0x0002C8, "Member 'ACompositingElement::ResolutionSource' has a wrong offset!");
static_assert(offsetof(ACompositingElement, RenderResolution) == 0x0002CC, "Member 'ACompositingElement::RenderResolution' has a wrong offset!");
static_assert(offsetof(ACompositingElement, RenderFormat) == 0x0002D4, "Member 'ACompositingElement::RenderFormat' has a wrong offset!");
static_assert(offsetof(ACompositingElement, bUseSharedTargetPool) == 0x0002D5, "Member 'ACompositingElement::bUseSharedTargetPool' has a wrong offset!");
static_assert(offsetof(ACompositingElement, FreezeFrameMask) == 0x000308, "Member 'ACompositingElement::FreezeFrameMask' has a wrong offset!");
static_assert(offsetof(ACompositingElement, OnTransformPassRendered_BP) == 0x000310, "Member 'ACompositingElement::OnTransformPassRendered_BP' has a wrong offset!");
static_assert(offsetof(ACompositingElement, OnFinalPassRendered_BP) == 0x000320, "Member 'ACompositingElement::OnFinalPassRendered_BP' has a wrong offset!");
static_assert(offsetof(ACompositingElement, CompShotIdName) == 0x000330, "Member 'ACompositingElement::CompShotIdName' has a wrong offset!");
static_assert(offsetof(ACompositingElement, Parent) == 0x000338, "Member 'ACompositingElement::Parent' has a wrong offset!");
static_assert(offsetof(ACompositingElement, ChildLayers) == 0x000340, "Member 'ACompositingElement::ChildLayers' has a wrong offset!");
static_assert(offsetof(ACompositingElement, OutputOpacity) == 0x000354, "Member 'ACompositingElement::OutputOpacity' has a wrong offset!");
static_assert(offsetof(ACompositingElement, UserConstructedInputs) == 0x000358, "Member 'ACompositingElement::UserConstructedInputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, UserConstructedTransforms) == 0x0003A8, "Member 'ACompositingElement::UserConstructedTransforms' has a wrong offset!");
static_assert(offsetof(ACompositingElement, UserConstructedOutputs) == 0x0003F8, "Member 'ACompositingElement::UserConstructedOutputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalInputs) == 0x000448, "Member 'ACompositingElement::InternalInputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalTransformPasses) == 0x000458, "Member 'ACompositingElement::InternalTransformPasses' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalOutputs) == 0x000468, "Member 'ACompositingElement::InternalOutputs' has a wrong offset!");
static_assert(offsetof(ACompositingElement, InternalAlphaPass) == 0x000478, "Member 'ACompositingElement::InternalAlphaPass' has a wrong offset!");
...
static_assert(sizeof(ACompositingCaptureBase) == 0x000580, "Wrong size on ACompositingCaptureBase");
static_assert(offsetof(ACompositingCaptureBase, SceneCaptureComponent2D) == 0x000538, "Member 'ACompositingCaptureBase::SceneCaptureComponent2D' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, bApplyDistortion) == 0x000540, "Member 'ACompositingCaptureBase::bApplyDistortion' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, LensComponentPicker) == 0x000548, "Member 'ACompositingCaptureBase::LensComponentPicker' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, OverscanFactor) == 0x000570, "Member 'ACompositingCaptureBase::OverscanFactor' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, OriginalFocalLength) == 0x000574, "Member 'ACompositingCaptureBase::OriginalFocalLength' has a wrong offset!");
static_assert(offsetof(ACompositingCaptureBase, LastDistortionMID) == 0x000578, "Member 'ACompositingCaptureBase::LastDistortionMID' has a wrong offset!");
...
static_assert(sizeof(UComposurePostProcessPass) == 0x000210, "Wrong size on UComposurePostProcessPass");
static_assert(offsetof(UComposurePostProcessPass, SceneCapture) == 0x0001F0, "Member 'UComposurePostProcessPass::SceneCapture' has a wrong offset!");
static_assert(offsetof(UComposurePostProcessPass, BlendableInterface) == 0x0001F8, "Member 'UComposurePostProcessPass::BlendableInterface' has a wrong offset!");
static_assert(offsetof(UComposurePostProcessPass, SetupMaterial) == 0x000200, "Member 'UComposurePostProcessPass::SetupMaterial' has a wrong offset!");
static_assert(offsetof(UComposurePostProcessPass, TonemapperReplacement) == 0x000208, "Member 'UComposurePostProcessPass::TonemapperReplacement' has a wrong offset!");
...
static_assert(sizeof(UComposurePostProcessingPassProxy) == 0x000220, "Wrong size on UComposurePostProcessingPassProxy");
static_assert(offsetof(UComposurePostProcessingPassProxy, SetupMID) == 0x000210, "Member 'UComposurePostProcessingPassProxy::SetupMID' has a wrong offset!");
...
static_assert(sizeof(UComposureLensBloomPass) == 0x0002D0, "Wrong size on UComposureLensBloomPass");
static_assert(offsetof(UComposureLensBloomPass, Settings) == 0x000210, "Member 'UComposureLensBloomPass::Settings' has a wrong offset!");
static_assert(offsetof(UComposureLensBloomPass, TonemapperReplacingMID) == 0x0002C8, "Member 'UComposureLensBloomPass::TonemapperReplacingMID' has a wrong offset!");
...
static_assert(sizeof(UComposureTonemapperPass) == 0x000380, "Wrong size on UComposureTonemapperPass");
static_assert(offsetof(UComposureTonemapperPass, ColorGradingSettings) == 0x000210, "Member 'UComposureTonemapperPass::ColorGradingSettings' has a wrong offset!");
static_assert(offsetof(UComposureTonemapperPass, FilmStockSettings) == 0x000360, "Member 'UComposureTonemapperPass::FilmStockSettings' has a wrong offset!");
static_assert(offsetof(UComposureTonemapperPass, ChromaticAberration) == 0x000374, "Member 'UComposureTonemapperPass::ChromaticAberration' has a wrong offset!");
