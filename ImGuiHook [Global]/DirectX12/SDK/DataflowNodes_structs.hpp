...
public:
	...
	struct FTransform                             TransformOut;                                      // 0x0100(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FSkeletalMeshReferenceTransformDataflowNode) == 0x000130, "Wrong size on FSkeletalMeshReferenceTransformDataflowNode");
