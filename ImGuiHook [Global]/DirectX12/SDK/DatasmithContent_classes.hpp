...
public:
	...
	class UTextureLightProfile*                   IESTexture;                                        // 0x0270(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TSoftObjectPtr<class UTextureLightProfile>    IESTexture;                                        // 0x0058(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDatasmithAreaLightActorTemplate) == 0x0000A8, "Wrong size on UDatasmithAreaLightActorTemplate");
...
static_assert(offsetof(UDatasmithAreaLightActorTemplate, bUseIESBrightness) == 0x000088, "Member 'UDatasmithAreaLightActorTemplate::bUseIESBrightness' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, IESBrightnessScale) == 0x00008C, "Member 'UDatasmithAreaLightActorTemplate::IESBrightnessScale' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, Rotation) == 0x000090, "Member 'UDatasmithAreaLightActorTemplate::Rotation' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, SourceRadius) == 0x00009C, "Member 'UDatasmithAreaLightActorTemplate::SourceRadius' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, SourceLength) == 0x0000A0, "Member 'UDatasmithAreaLightActorTemplate::SourceLength' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, AttenuationRadius) == 0x0000A4, "Member 'UDatasmithAreaLightActorTemplate::AttenuationRadius' has a wrong offset!");
...
public:
	...
	struct FDatasmithPostProcessSettingsTemplate  PostProcessSettings;                               // 0x0050(0x0030)(NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	class UMaterialInterface*                     Material;                                          // 0x0040(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TArray<class ULevelSequence*>                 ImportedSequences;                                 // 0x0248(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
{
public:
	struct FDatasmithPostProcessSettingsTemplate  Settings;                                          // 0x0030(0x0030)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         bEnabled : 1;                                      // 0x0060(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUnbound : 1;                                      // 0x0060(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UDatasmithPostProcessVolumeTemplate) == 0x000070, "Wrong size on UDatasmithPostProcessVolumeTemplate");
...
{
public:
	class UDatasmithScene*                        Scene;                                             // 0x0248(0x0008)(Edit, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FTransform                             RelativeTransform;                                 // 0x0030(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class USceneComponent>         AttachParent;                                      // 0x0068(0x0030)(ExportObject, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bVisible;                                          // 0x0098(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCastShadow;                                       // 0x0099(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9A[0x6];                                       // 0x009A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class FName>                             Tags;                                              // 0x00A0(0x0050)(NativeAccessSpecifierPublic)
...
static_assert(offsetof(UDatasmithSceneComponentTemplate, bVisible) == 0x000098, "Member 'UDatasmithSceneComponentTemplate::bVisible' has a wrong offset!");
static_assert(offsetof(UDatasmithSceneComponentTemplate, bCastShadow) == 0x000099, "Member 'UDatasmithSceneComponentTemplate::bCastShadow' has a wrong offset!");
static_assert(offsetof(UDatasmithSceneComponentTemplate, Tags) == 0x0000A0, "Member 'UDatasmithSceneComponentTemplate::Tags' has a wrong offset!");
