...
#include "EsiemoExplosionValue_classes.hpp"
#include "EsiemoExplosionValue_parameters.hpp"
...
struct FM1ScaledInteger UEsiemoExplosionValue_C::CalculateValue(const struct FM1AbilityOpCalcParam& Param) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EsiemoExplosionValue_C", "CalculateValue");

	Params::EsiemoExplosionValue_C_CalculateValue Parms{};
