...
static_assert(sizeof(UAudioCurveSourceComponent) == 0x000BD0, "Wrong size on UAudioCurveSourceComponent");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSourceBindingName) == 0x000B90, "Member 'UAudioCurveSourceComponent::CurveSourceBindingName' has a wrong offset!");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSyncOffset) == 0x000B98, "Member 'UAudioCurveSourceComponent::CurveSyncOffset' has a wrong offset!");
