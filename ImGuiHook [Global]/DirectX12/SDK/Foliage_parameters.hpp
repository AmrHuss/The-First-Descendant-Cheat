...
static_assert(sizeof(FoliageStatistics_FoliageOverlappingBoxTransforms) == 0x000040, "Wrong size on FoliageStatistics_FoliageOverlappingBoxTransforms");
...
static_assert(offsetof(FoliageStatistics_FoliageOverlappingBoxTransforms, OutTransforms) == 0x000030, "Member 'FoliageStatistics_FoliageOverlappingBoxTransforms::OutTransforms' has a wrong offset!");
...
public:
	...
	struct FHitResult                             OverlapInfo;                                       // 0x0020(0x009C)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(InteractiveFoliageActor_CapsuleTouched) == 0x0000C0, "Wrong size on InteractiveFoliageActor_CapsuleTouched");
