...
static_assert(offsetof(UGLTFExportOptions, bExportProxyMaterials) == 0x00002E, "Member 'UGLTFExportOptions::bExportProxyMaterials' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportUnlitMaterials) == 0x00002F, "Member 'UGLTFExportOptions::bExportUnlitMaterials' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportClearCoatMaterials) == 0x000030, "Member 'UGLTFExportOptions::bExportClearCoatMaterials' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, BakeMaterialInputs) == 0x000031, "Member 'UGLTFExportOptions::BakeMaterialInputs' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, DefaultMaterialBakeSize) == 0x000032, "Member 'UGLTFExportOptions::DefaultMaterialBakeSize' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, DefaultMaterialBakeFilter) == 0x000033, "Member 'UGLTFExportOptions::DefaultMaterialBakeFilter' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, DefaultMaterialBakeTiling) == 0x000034, "Member 'UGLTFExportOptions::DefaultMaterialBakeTiling' has a wrong offset!");
