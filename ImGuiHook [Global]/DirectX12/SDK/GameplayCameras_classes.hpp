...
static_assert(sizeof(ULegacyCameraShake) == 0x0001A0, "Wrong size on ULegacyCameraShake");
static_assert(offsetof(ULegacyCameraShake, OscillationDuration) == 0x0000A8, "Member 'ULegacyCameraShake::OscillationDuration' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, OscillationBlendInTime) == 0x0000AC, "Member 'ULegacyCameraShake::OscillationBlendInTime' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, OscillationBlendOutTime) == 0x0000B0, "Member 'ULegacyCameraShake::OscillationBlendOutTime' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, RotOscillation) == 0x0000B4, "Member 'ULegacyCameraShake::RotOscillation' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, LocOscillation) == 0x0000D8, "Member 'ULegacyCameraShake::LocOscillation' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, FOVOscillation) == 0x0000FC, "Member 'ULegacyCameraShake::FOVOscillation' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, AnimPlayRate) == 0x000108, "Member 'ULegacyCameraShake::AnimPlayRate' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, AnimScale) == 0x00010C, "Member 'ULegacyCameraShake::AnimScale' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, AnimBlendInTime) == 0x000110, "Member 'ULegacyCameraShake::AnimBlendInTime' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, AnimBlendOutTime) == 0x000114, "Member 'ULegacyCameraShake::AnimBlendOutTime' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, RandomAnimSegmentDuration) == 0x000118, "Member 'ULegacyCameraShake::RandomAnimSegmentDuration' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, AnimSequence) == 0x000120, "Member 'ULegacyCameraShake::AnimSequence' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, OscillatorTimeRemaining) == 0x00012C, "Member 'ULegacyCameraShake::OscillatorTimeRemaining' has a wrong offset!");
static_assert(offsetof(ULegacyCameraShake, SequenceShakePattern) == 0x000168, "Member 'ULegacyCameraShake::SequenceShakePattern' has a wrong offset!");
