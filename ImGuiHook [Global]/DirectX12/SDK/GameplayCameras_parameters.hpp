...
public:
	...
	class ULegacyCameraShake*                     ReturnValue;                                       // 0x0028(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(LegacyCameraShake_StartLegacyCameraShake) == 0x000030, "Wrong size on LegacyCameraShake_StartLegacyCameraShake");
...
static_assert(offsetof(LegacyCameraShake_StartLegacyCameraShake, ReturnValue) == 0x000028, "Member 'LegacyCameraShake_StartLegacyCameraShake::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(LegacyCameraShake_StartLegacyCameraShakeFromSource) == 0x000038, "Wrong size on LegacyCameraShake_StartLegacyCameraShakeFromSource");
...
static_assert(offsetof(LegacyCameraShake_StartLegacyCameraShakeFromSource, ReturnValue) == 0x000030, "Member 'LegacyCameraShake_StartLegacyCameraShakeFromSource::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FMinimalViewInfo                       POV;                                               // 0x0010(0x0900)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FMinimalViewInfo                       ModifiedPOV;                                       // 0x0910(0x0900)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(LegacyCameraShake_BlueprintUpdateCameraShake) == 0x001210, "Wrong size on LegacyCameraShake_BlueprintUpdateCameraShake");
...
static_assert(offsetof(LegacyCameraShake_BlueprintUpdateCameraShake, ModifiedPOV) == 0x000910, "Member 'LegacyCameraShake_BlueprintUpdateCameraShake::ModifiedPOV' has a wrong offset!");
...
static_assert(sizeof(CameraAnimationCameraModifier_PlayCameraAnimation) == 0x000040, "Wrong size on CameraAnimationCameraModifier_PlayCameraAnimation");
...
static_assert(offsetof(CameraAnimationCameraModifier_PlayCameraAnimation, ReturnValue) == 0x000038, "Member 'CameraAnimationCameraModifier_PlayCameraAnimation::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FCameraAnimationParams                 Params_0;                                          // 0x0010(0x0030)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	struct FCameraAnimationHandle                 ReturnValue;                                       // 0x0040(0x0004)(Parm, OutParm, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GameplayCamerasSubsystem_PlayCameraAnimation) == 0x000048, "Wrong size on GameplayCamerasSubsystem_PlayCameraAnimation");
...
static_assert(offsetof(GameplayCamerasSubsystem_PlayCameraAnimation, ReturnValue) == 0x000040, "Member 'GameplayCamerasSubsystem_PlayCameraAnimation::ReturnValue' has a wrong offset!");
