...
public:
	...
	struct FRotator                               UserPlaySpaceRot;                                  // 0x0024(0x000C)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCameraAnimationParams) == 0x000004, "Wrong alignment on FCameraAnimationParams");
static_assert(sizeof(FCameraAnimationParams) == 0x000030, "Wrong size on FCameraAnimationParams");
...
static_assert(offsetof(FCameraAnimationParams, UserPlaySpaceRot) == 0x000024, "Member 'FCameraAnimationParams::UserPlaySpaceRot' has a wrong offset!");
...
public:
	...
	struct FCameraAnimationParams                 Params;                                            // 0x0008(0x0030)(NoDestructor, NativeAccessSpecifierPublic)
	struct FCameraAnimationHandle                 Handle;                                            // 0x0038(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCameraAnimationSequencePlayer*         Player;                                            // 0x0040(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCameraAnimationSequenceCameraStandIn*  CameraStandIn;                                     // 0x0048(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EaseInCurrentTime;                                 // 0x0050(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EaseOutCurrentTime;                                // 0x0054(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsEasingIn;                                       // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsEasingOut;                                      // 0x0059(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5A[0x6];                                       // 0x005A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FActiveCameraAnimationInfo) == 0x000008, "Wrong alignment on FActiveCameraAnimationInfo");
static_assert(sizeof(FActiveCameraAnimationInfo) == 0x000060, "Wrong size on FActiveCameraAnimationInfo");
...
static_assert(offsetof(FActiveCameraAnimationInfo, Handle) == 0x000038, "Member 'FActiveCameraAnimationInfo::Handle' has a wrong offset!");
static_assert(offsetof(FActiveCameraAnimationInfo, Player) == 0x000040, "Member 'FActiveCameraAnimationInfo::Player' has a wrong offset!");
static_assert(offsetof(FActiveCameraAnimationInfo, CameraStandIn) == 0x000048, "Member 'FActiveCameraAnimationInfo::CameraStandIn' has a wrong offset!");
static_assert(offsetof(FActiveCameraAnimationInfo, EaseInCurrentTime) == 0x000050, "Member 'FActiveCameraAnimationInfo::EaseInCurrentTime' has a wrong offset!");
static_assert(offsetof(FActiveCameraAnimationInfo, EaseOutCurrentTime) == 0x000054, "Member 'FActiveCameraAnimationInfo::EaseOutCurrentTime' has a wrong offset!");
static_assert(offsetof(FActiveCameraAnimationInfo, bIsEasingIn) == 0x000058, "Member 'FActiveCameraAnimationInfo::bIsEasingIn' has a wrong offset!");
static_assert(offsetof(FActiveCameraAnimationInfo, bIsEasingOut) == 0x000059, "Member 'FActiveCameraAnimationInfo::bIsEasingOut' has a wrong offset!");
