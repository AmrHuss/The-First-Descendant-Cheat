...
public:
	...
	float                                         Mass;                                              // 0x000C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ParticleIndex;                                     // 0x0010(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FChaosRemovalEventData) == 0x000004, "Wrong alignment on FChaosRemovalEventData");
static_assert(sizeof(FChaosRemovalEventData) == 0x000014, "Wrong size on FChaosRemovalEventData");
...
static_assert(offsetof(FChaosRemovalEventData, Mass) == 0x00000C, "Member 'FChaosRemovalEventData::Mass' has a wrong offset!");
static_assert(offsetof(FChaosRemovalEventData, ParticleIndex) == 0x000010, "Member 'FChaosRemovalEventData::ParticleIndex' has a wrong offset!");
...
static_assert(sizeof(FChaosCollisionEventData) == 0x000044, "Wrong size on FChaosCollisionEventData");
...
public:
	...
	struct FTransform                             LocalTransform;                                    // 0x0020(0x0030)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UMaterialInterface*>             SourceMaterial;                                    // 0x0050(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	bool                                          bAddInternalMaterials;                             // 0x0060(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSplitComponents;                                  // 0x0061(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGeometryCollectionSource) == 0x000070, "Wrong size on FGeometryCollectionSource");
...
static_assert(offsetof(FGeometryCollectionSource, bAddInternalMaterials) == 0x000060, "Member 'FGeometryCollectionSource::bAddInternalMaterials' has a wrong offset!");
static_assert(offsetof(FGeometryCollectionSource, bSplitComponents) == 0x000061, "Member 'FGeometryCollectionSource::bSplitComponents' has a wrong offset!");
