...
public:
	...
	struct FQuat                                  Rotation;                                          // 0x0030(0x0010)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FQuat                                  GripRotation;                                      // 0x0030(0x0010)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FQuat                                  AimRotation;                                       // 0x0050(0x0010)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PalmPosition;                                      // 0x0060(0x000C)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FQuat                                  PalmRotation;                                      // 0x0070(0x0010)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FVector>                        HandKeyPositions;                                  // 0x0080(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FQuat>                          HandKeyRotations;                                  // 0x0090(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 HandKeyRadii;                                      // 0x00A0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bIsGrasped;                                        // 0x00B0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FXRMotionControllerData) == 0x0000C0, "Wrong size on FXRMotionControllerData");
...
static_assert(offsetof(FXRMotionControllerData, PalmPosition) == 0x000060, "Member 'FXRMotionControllerData::PalmPosition' has a wrong offset!");
static_assert(offsetof(FXRMotionControllerData, PalmRotation) == 0x000070, "Member 'FXRMotionControllerData::PalmRotation' has a wrong offset!");
static_assert(offsetof(FXRMotionControllerData, HandKeyPositions) == 0x000080, "Member 'FXRMotionControllerData::HandKeyPositions' has a wrong offset!");
static_assert(offsetof(FXRMotionControllerData, HandKeyRotations) == 0x000090, "Member 'FXRMotionControllerData::HandKeyRotations' has a wrong offset!");
static_assert(offsetof(FXRMotionControllerData, HandKeyRadii) == 0x0000A0, "Member 'FXRMotionControllerData::HandKeyRadii' has a wrong offset!");
static_assert(offsetof(FXRMotionControllerData, bIsGrasped) == 0x0000B0, "Member 'FXRMotionControllerData::bIsGrasped' has a wrong offset!");
