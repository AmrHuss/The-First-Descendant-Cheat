...
#include "HpRatioBased_classes.hpp"
#include "HpRatioBased_parameters.hpp"
...
struct FM1ScaledInteger UHpRatioBased_C::CalculateValue(const struct FM1AbilityOpCalcParam& Param) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HpRatioBased_C", "CalculateValue");

	Params::HpRatioBased_C_CalculateValue Parms{};
