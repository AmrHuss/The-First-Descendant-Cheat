...
public:
	...
	struct FTransform                             CurrentTransform;                                  // 0x0040(0x0030)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTransform                             InitialTransform;                                  // 0x0070(0x0030)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UIKRigEffectorGoal) == 0x0000A0, "Wrong size on UIKRigEffectorGoal");
...
static_assert(offsetof(UIKRigEffectorGoal, InitialTransform) == 0x000070, "Member 'UIKRigEffectorGoal::InitialTransform' has a wrong offset!");
...
public:
	...
	struct FTargetChainSettings                   Settings;                                          // 0x0038(0x0074)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URetargetChainSettings) == 0x0000B0, "Wrong size on URetargetChainSettings");
...
{
public:
	struct FTargetRootSettings                    Settings;                                          // 0x0028(0x0040)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URetargetRootSettings) == 0x000068, "Wrong size on URetargetRootSettings");
...
public:
	...
	uint8                                         Pad_178[0x148];                                    // 0x0178(0x0148)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIKRetargetProcessor) == 0x0002C0, "Wrong size on UIKRetargetProcessor");
...
public:
	...
	struct FVector                                PreferredAngles;                                   // 0x0060(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UIKRig_FBIKBoneSettings) == 0x000070, "Wrong size on UIKRig_FBIKBoneSettings");
