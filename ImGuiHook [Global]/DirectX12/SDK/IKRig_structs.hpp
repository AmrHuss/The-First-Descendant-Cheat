...
static_assert(sizeof(FTargetChainIKSettings) == 0x000044, "Wrong size on FTargetChainIKSettings");
...
static_assert(offsetof(FTargetChainIKSettings, StaticOffset) == 0x000014, "Member 'FTargetChainIKSettings::StaticOffset' has a wrong offset!");
static_assert(offsetof(FTargetChainIKSettings, StaticLocalOffset) == 0x000020, "Member 'FTargetChainIKSettings::StaticLocalOffset' has a wrong offset!");
static_assert(offsetof(FTargetChainIKSettings, StaticRotationOffset) == 0x00002C, "Member 'FTargetChainIKSettings::StaticRotationOffset' has a wrong offset!");
static_assert(offsetof(FTargetChainIKSettings, ScaleVertical) == 0x000038, "Member 'FTargetChainIKSettings::ScaleVertical' has a wrong offset!");
static_assert(offsetof(FTargetChainIKSettings, Extension) == 0x00003C, "Member 'FTargetChainIKSettings::Extension' has a wrong offset!");
static_assert(offsetof(FTargetChainIKSettings, bAffectedByIKWarping) == 0x000040, "Member 'FTargetChainIKSettings::bAffectedByIKWarping' has a wrong offset!");
...
static_assert(alignof(FTargetChainSettings) == 0x000004, "Wrong alignment on FTargetChainSettings");
static_assert(sizeof(FTargetChainSettings) == 0x000074, "Wrong size on FTargetChainSettings");
...
static_assert(offsetof(FTargetChainSettings, SpeedPlanting) == 0x00005C, "Member 'FTargetChainSettings::SpeedPlanting' has a wrong offset!");
...
static_assert(sizeof(FTargetRootSettings) == 0x000040, "Wrong size on FTargetRootSettings");
...
static_assert(offsetof(FTargetRootSettings, BlendToSourceWeights) == 0x00000C, "Member 'FTargetRootSettings::BlendToSourceWeights' has a wrong offset!");
static_assert(offsetof(FTargetRootSettings, ScaleHorizontal) == 0x000018, "Member 'FTargetRootSettings::ScaleHorizontal' has a wrong offset!");
static_assert(offsetof(FTargetRootSettings, ScaleVertical) == 0x00001C, "Member 'FTargetRootSettings::ScaleVertical' has a wrong offset!");
static_assert(offsetof(FTargetRootSettings, TranslationOffset) == 0x000020, "Member 'FTargetRootSettings::TranslationOffset' has a wrong offset!");
static_assert(offsetof(FTargetRootSettings, RotationOffset) == 0x00002C, "Member 'FTargetRootSettings::RotationOffset' has a wrong offset!");
static_assert(offsetof(FTargetRootSettings, AffectIKHorizontal) == 0x000038, "Member 'FTargetRootSettings::AffectIKHorizontal' has a wrong offset!");
static_assert(offsetof(FTargetRootSettings, AffectIKVertical) == 0x00003C, "Member 'FTargetRootSettings::AffectIKVertical' has a wrong offset!");
...
static_assert(sizeof(FRetargetProfile) == 0x0000D8, "Wrong size on FRetargetProfile");
...
static_assert(offsetof(FRetargetProfile, RootSettings) == 0x000074, "Member 'FRetargetProfile::RootSettings' has a wrong offset!");
static_assert(offsetof(FRetargetProfile, bApplyGlobalSettings) == 0x0000B4, "Member 'FRetargetProfile::bApplyGlobalSettings' has a wrong offset!");
static_assert(offsetof(FRetargetProfile, GlobalSettings) == 0x0000B8, "Member 'FRetargetProfile::GlobalSettings' has a wrong offset!");
...
static_assert(sizeof(FIKRigGoal) == 0x000060, "Wrong size on FIKRigGoal");
...
static_assert(offsetof(FIKRigGoal, Position) == 0x00001C, "Member 'FIKRigGoal::Position' has a wrong offset!");
static_assert(offsetof(FIKRigGoal, Rotation) == 0x000028, "Member 'FIKRigGoal::Rotation' has a wrong offset!");
static_assert(offsetof(FIKRigGoal, PositionAlpha) == 0x000034, "Member 'FIKRigGoal::PositionAlpha' has a wrong offset!");
static_assert(offsetof(FIKRigGoal, RotationAlpha) == 0x000038, "Member 'FIKRigGoal::RotationAlpha' has a wrong offset!");
static_assert(offsetof(FIKRigGoal, PositionSpace) == 0x00003C, "Member 'FIKRigGoal::PositionSpace' has a wrong offset!");
static_assert(offsetof(FIKRigGoal, RotationSpace) == 0x00003D, "Member 'FIKRigGoal::RotationSpace' has a wrong offset!");
static_assert(offsetof(FIKRigGoal, FinalBlendedPosition) == 0x000040, "Member 'FIKRigGoal::FinalBlendedPosition' has a wrong offset!");
static_assert(offsetof(FIKRigGoal, FinalBlendedRotation) == 0x000050, "Member 'FIKRigGoal::FinalBlendedRotation' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RetargetPoseFromMesh) == 0x000228, "Wrong size on FAnimNode_RetargetPoseFromMesh");
...
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, bSuppressWarnings) == 0x000100, "Member 'FAnimNode_RetargetPoseFromMesh::bSuppressWarnings' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, bCopyCurves) == 0x000101, "Member 'FAnimNode_RetargetPoseFromMesh::bCopyCurves' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, Processor) == 0x000108, "Member 'FAnimNode_RetargetPoseFromMesh::Processor' has a wrong offset!");
...
static_assert(sizeof(FIKRetargetPose) == 0x000060, "Wrong size on FIKRetargetPose");
...
static_assert(offsetof(FIKRetargetPose, BoneRotationOffsets) == 0x000010, "Member 'FIKRetargetPose::BoneRotationOffsets' has a wrong offset!");
...
static_assert(alignof(FLimbLink) == 0x000004, "Wrong alignment on FLimbLink");
static_assert(sizeof(FLimbLink) == 0x000038, "Wrong size on FLimbLink");
