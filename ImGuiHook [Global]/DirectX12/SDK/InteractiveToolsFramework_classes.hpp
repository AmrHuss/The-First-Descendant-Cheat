...
{
public:
	struct FLinearColor                           Color;                                             // 0x0470(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HoverSizeMultiplier;                               // 0x0480(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PixelHitDistanceThreshold;                         // 0x0484(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_488[0x8];                                      // 0x0488(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UGizmoViewContext*                      GizmoViewContext;                                  // 0x0490(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x000470, "Member 'UGizmoBaseComponent::Color' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, HoverSizeMultiplier) == 0x000480, "Member 'UGizmoBaseComponent::HoverSizeMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, PixelHitDistanceThreshold) == 0x000484, "Member 'UGizmoBaseComponent::PixelHitDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, GizmoViewContext) == 0x000490, "Member 'UGizmoBaseComponent::GizmoViewContext' has a wrong offset!");
...
static_assert(sizeof(UInputRouter) == 0x000168, "Wrong size on UInputRouter");
...
{
public:
	bool                                          bIsSelectableInEditor;                             // 0x0248(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AInternalToolFrameworkActor) == 0x000250, "Wrong size on AInternalToolFrameworkActor");
static_assert(offsetof(AInternalToolFrameworkActor, bIsSelectableInEditor) == 0x000248, "Member 'AInternalToolFrameworkActor::bIsSelectableInEditor' has a wrong offset!");
...
public:
	...
	struct FVector                                CurTranslationAxis;                                // 0x00FC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CurTranslationOrigin;                              // 0x0108(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_114[0xC];                                      // 0x0114(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             InitialTransform;                                  // 0x0120(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoAxisTranslationParameterSource, CurTranslationAxis) == 0x0000FC, "Member 'UGizmoAxisTranslationParameterSource::CurTranslationAxis' has a wrong offset!");
static_assert(offsetof(UGizmoAxisTranslationParameterSource, CurTranslationOrigin) == 0x000108, "Member 'UGizmoAxisTranslationParameterSource::CurTranslationOrigin' has a wrong offset!");
static_assert(offsetof(UGizmoAxisTranslationParameterSource, InitialTransform) == 0x000120, "Member 'UGizmoAxisTranslationParameterSource::InitialTransform' has a wrong offset!");
...
public:
	...
	struct FVector2D                              Parameter;                                         // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGizmoVec2ParameterChange              LastChange;                                        // 0x0138(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                CurTranslationOrigin;                              // 0x0148(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CurTranslationNormal;                              // 0x0154(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CurTranslationAxisX;                               // 0x0160(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CurTranslationAxisY;                               // 0x016C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_178[0x8];                                      // 0x0178(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             InitialTransform;                                  // 0x0180(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGizmoPlaneTranslationParameterSource) == 0x0001B0, "Wrong size on UGizmoPlaneTranslationParameterSource");
...
static_assert(offsetof(UGizmoPlaneTranslationParameterSource, LastChange) == 0x000138, "Member 'UGizmoPlaneTranslationParameterSource::LastChange' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneTranslationParameterSource, CurTranslationOrigin) == 0x000148, "Member 'UGizmoPlaneTranslationParameterSource::CurTranslationOrigin' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneTranslationParameterSource, CurTranslationNormal) == 0x000154, "Member 'UGizmoPlaneTranslationParameterSource::CurTranslationNormal' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneTranslationParameterSource, CurTranslationAxisX) == 0x000160, "Member 'UGizmoPlaneTranslationParameterSource::CurTranslationAxisX' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneTranslationParameterSource, CurTranslationAxisY) == 0x00016C, "Member 'UGizmoPlaneTranslationParameterSource::CurTranslationAxisY' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneTranslationParameterSource, InitialTransform) == 0x000180, "Member 'UGizmoPlaneTranslationParameterSource::InitialTransform' has a wrong offset!");
...
public:
	...
	struct FGizmoFloatParameterChange             LastChange;                                        // 0x00F4(0x0008)(NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                CurRotationAxis;                                   // 0x00FC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CurRotationOrigin;                                 // 0x0108(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_114[0xC];                                      // 0x0114(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             InitialTransform;                                  // 0x0120(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoAxisRotationParameterSource, CurRotationAxis) == 0x0000FC, "Member 'UGizmoAxisRotationParameterSource::CurRotationAxis' has a wrong offset!");
static_assert(offsetof(UGizmoAxisRotationParameterSource, CurRotationOrigin) == 0x000108, "Member 'UGizmoAxisRotationParameterSource::CurRotationOrigin' has a wrong offset!");
static_assert(offsetof(UGizmoAxisRotationParameterSource, InitialTransform) == 0x000120, "Member 'UGizmoAxisRotationParameterSource::InitialTransform' has a wrong offset!");
...
public:
	...
	struct FTransform                             InitialTransform;                                  // 0x00C0(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FVector                                CurScaleAxis;                                      // 0x007C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CurScaleOrigin;                                    // 0x0088(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_94[0xC];                                       // 0x0094(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             InitialTransform;                                  // 0x00A0(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoAxisScaleParameterSource, CurScaleAxis) == 0x00007C, "Member 'UGizmoAxisScaleParameterSource::CurScaleAxis' has a wrong offset!");
static_assert(offsetof(UGizmoAxisScaleParameterSource, CurScaleOrigin) == 0x000088, "Member 'UGizmoAxisScaleParameterSource::CurScaleOrigin' has a wrong offset!");
...
public:
	...
	struct FVector2D                              Parameter;                                         // 0x00B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGizmoVec2ParameterChange              LastChange;                                        // 0x00C0(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                CurScaleOrigin;                                    // 0x00D0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CurScaleNormal;                                    // 0x00DC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CurScaleAxisX;                                     // 0x00E8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CurScaleAxisY;                                     // 0x00F4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTransform                             InitialTransform;                                  // 0x0100(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoPlaneScaleParameterSource, LastChange) == 0x0000C0, "Member 'UGizmoPlaneScaleParameterSource::LastChange' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, CurScaleOrigin) == 0x0000D0, "Member 'UGizmoPlaneScaleParameterSource::CurScaleOrigin' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, CurScaleNormal) == 0x0000DC, "Member 'UGizmoPlaneScaleParameterSource::CurScaleNormal' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, CurScaleAxisX) == 0x0000E8, "Member 'UGizmoPlaneScaleParameterSource::CurScaleAxisX' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, CurScaleAxisY) == 0x0000F4, "Member 'UGizmoPlaneScaleParameterSource::CurScaleAxisY' has a wrong offset!");
...
static_assert(sizeof(USingleClickOrDragInputBehavior) == 0x000160, "Wrong size on USingleClickOrDragInputBehavior");
...
public:
	...
	struct FVector                                RotationOrigin;                                    // 0x0114(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                RotationAxis;                                      // 0x0120(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                RotationPlaneX;                                    // 0x012C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                RotationPlaneY;                                    // 0x0138(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionStartPoint;                             // 0x0144(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionCurPoint;                               // 0x0150(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InteractionStartAngle;                             // 0x015C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InteractionCurAngle;                               // 0x0160(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAxisAngleGizmo) == 0x000180, "Wrong size on UAxisAngleGizmo");
...
static_assert(offsetof(UAxisAngleGizmo, RotationOrigin) == 0x000114, "Member 'UAxisAngleGizmo::RotationOrigin' has a wrong offset!");
static_assert(offsetof(UAxisAngleGizmo, RotationAxis) == 0x000120, "Member 'UAxisAngleGizmo::RotationAxis' has a wrong offset!");
static_assert(offsetof(UAxisAngleGizmo, RotationPlaneX) == 0x00012C, "Member 'UAxisAngleGizmo::RotationPlaneX' has a wrong offset!");
static_assert(offsetof(UAxisAngleGizmo, RotationPlaneY) == 0x000138, "Member 'UAxisAngleGizmo::RotationPlaneY' has a wrong offset!");
static_assert(offsetof(UAxisAngleGizmo, InteractionStartPoint) == 0x000144, "Member 'UAxisAngleGizmo::InteractionStartPoint' has a wrong offset!");
static_assert(offsetof(UAxisAngleGizmo, InteractionCurPoint) == 0x000150, "Member 'UAxisAngleGizmo::InteractionCurPoint' has a wrong offset!");
static_assert(offsetof(UAxisAngleGizmo, InteractionStartAngle) == 0x00015C, "Member 'UAxisAngleGizmo::InteractionStartAngle' has a wrong offset!");
static_assert(offsetof(UAxisAngleGizmo, InteractionCurAngle) == 0x000160, "Member 'UAxisAngleGizmo::InteractionCurAngle' has a wrong offset!");
...
public:
	...
	struct FVector                                InteractionOrigin;                                 // 0x0124(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionAxis;                                   // 0x0130(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionStartPoint;                             // 0x013C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionCurPoint;                               // 0x0148(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InteractionStartParameter;                         // 0x0154(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InteractionCurParameter;                           // 0x0158(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ParameterSign;                                     // 0x015C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAxisPositionGizmo) == 0x000180, "Wrong size on UAxisPositionGizmo");
...
static_assert(offsetof(UAxisPositionGizmo, InteractionOrigin) == 0x000124, "Member 'UAxisPositionGizmo::InteractionOrigin' has a wrong offset!");
static_assert(offsetof(UAxisPositionGizmo, InteractionAxis) == 0x000130, "Member 'UAxisPositionGizmo::InteractionAxis' has a wrong offset!");
static_assert(offsetof(UAxisPositionGizmo, InteractionStartPoint) == 0x00013C, "Member 'UAxisPositionGizmo::InteractionStartPoint' has a wrong offset!");
static_assert(offsetof(UAxisPositionGizmo, InteractionCurPoint) == 0x000148, "Member 'UAxisPositionGizmo::InteractionCurPoint' has a wrong offset!");
static_assert(offsetof(UAxisPositionGizmo, InteractionStartParameter) == 0x000154, "Member 'UAxisPositionGizmo::InteractionStartParameter' has a wrong offset!");
static_assert(offsetof(UAxisPositionGizmo, InteractionCurParameter) == 0x000158, "Member 'UAxisPositionGizmo::InteractionCurParameter' has a wrong offset!");
static_assert(offsetof(UAxisPositionGizmo, ParameterSign) == 0x00015C, "Member 'UAxisPositionGizmo::ParameterSign' has a wrong offset!");
...
public:
	...
	struct FVector                                ActiveAxis;                                        // 0x00B0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                DragStartWorldPosition;                            // 0x00BC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                DragCurrentPositionProjected;                      // 0x00C8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         InteractionStartParameter;                         // 0x00D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UScalableSphereGizmo) == 0x0000E0, "Wrong size on UScalableSphereGizmo");
...
static_assert(offsetof(UScalableSphereGizmo, DragStartWorldPosition) == 0x0000BC, "Member 'UScalableSphereGizmo::DragStartWorldPosition' has a wrong offset!");
static_assert(offsetof(UScalableSphereGizmo, DragCurrentPositionProjected) == 0x0000C8, "Member 'UScalableSphereGizmo::DragCurrentPositionProjected' has a wrong offset!");
static_assert(offsetof(UScalableSphereGizmo, InteractionStartParameter) == 0x0000D4, "Member 'UScalableSphereGizmo::InteractionStartParameter' has a wrong offset!");
...
public:
	...
	struct FVector                                BrushPosition;                                     // 0x0044(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                BrushNormal;                                       // 0x0050(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawIndicatorLines;                               // 0x005C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawRadiusCircle;                                 // 0x005D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5E[0x2];                                       // 0x005E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         SampleStepCount;                                   // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           LineColor;                                         // 0x0064(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LineThickness;                                     // 0x0074(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDepthTested;                                      // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawSecondaryLines;                               // 0x0079(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7A[0x2];                                       // 0x007A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SecondaryLineThickness;                            // 0x007C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           SecondaryLineColor;                                // 0x0080(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AttachedComponent;                                 // 0x0090(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UBrushStampIndicator, BrushPosition) == 0x000044, "Member 'UBrushStampIndicator::BrushPosition' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, BrushNormal) == 0x000050, "Member 'UBrushStampIndicator::BrushNormal' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, bDrawIndicatorLines) == 0x00005C, "Member 'UBrushStampIndicator::bDrawIndicatorLines' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, bDrawRadiusCircle) == 0x00005D, "Member 'UBrushStampIndicator::bDrawRadiusCircle' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, SampleStepCount) == 0x000060, "Member 'UBrushStampIndicator::SampleStepCount' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, LineColor) == 0x000064, "Member 'UBrushStampIndicator::LineColor' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, LineThickness) == 0x000074, "Member 'UBrushStampIndicator::LineThickness' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, bDepthTested) == 0x000078, "Member 'UBrushStampIndicator::bDepthTested' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, bDrawSecondaryLines) == 0x000079, "Member 'UBrushStampIndicator::bDrawSecondaryLines' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, SecondaryLineThickness) == 0x00007C, "Member 'UBrushStampIndicator::SecondaryLineThickness' has a wrong offset!");
static_assert(offsetof(UBrushStampIndicator, SecondaryLineColor) == 0x000080, "Member 'UBrushStampIndicator::SecondaryLineColor' has a wrong offset!");
...
static_assert(sizeof(AGizmoActor) == 0x000250, "Wrong size on AGizmoActor");
...
{
public:
	class UPrimitiveComponent*                    TranslateX;                                        // 0x0250(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateY;                                        // 0x0258(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateZ;                                        // 0x0260(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateYZ;                                       // 0x0268(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateXZ;                                       // 0x0270(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateXY;                                       // 0x0278(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateX;                                           // 0x0280(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateY;                                           // 0x0288(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateZ;                                           // 0x0290(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotationSphere;                                    // 0x0298(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    UniformScale;                                      // 0x02A0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleX;                                        // 0x02A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleY;                                        // 0x02B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleZ;                                        // 0x02B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleYZ;                                      // 0x02C0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleXZ;                                      // 0x02C8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleXY;                                      // 0x02D0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ACombinedTransformGizmoActor) == 0x0002D8, "Wrong size on ACombinedTransformGizmoActor");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateX) == 0x000250, "Member 'ACombinedTransformGizmoActor::TranslateX' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateY) == 0x000258, "Member 'ACombinedTransformGizmoActor::TranslateY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateZ) == 0x000260, "Member 'ACombinedTransformGizmoActor::TranslateZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateYZ) == 0x000268, "Member 'ACombinedTransformGizmoActor::TranslateYZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateXZ) == 0x000270, "Member 'ACombinedTransformGizmoActor::TranslateXZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateXY) == 0x000278, "Member 'ACombinedTransformGizmoActor::TranslateXY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotateX) == 0x000280, "Member 'ACombinedTransformGizmoActor::RotateX' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotateY) == 0x000288, "Member 'ACombinedTransformGizmoActor::RotateY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotateZ) == 0x000290, "Member 'ACombinedTransformGizmoActor::RotateZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotationSphere) == 0x000298, "Member 'ACombinedTransformGizmoActor::RotationSphere' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, UniformScale) == 0x0002A0, "Member 'ACombinedTransformGizmoActor::UniformScale' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, AxisScaleX) == 0x0002A8, "Member 'ACombinedTransformGizmoActor::AxisScaleX' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, AxisScaleY) == 0x0002B0, "Member 'ACombinedTransformGizmoActor::AxisScaleY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, AxisScaleZ) == 0x0002B8, "Member 'ACombinedTransformGizmoActor::AxisScaleZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, PlaneScaleYZ) == 0x0002C0, "Member 'ACombinedTransformGizmoActor::PlaneScaleYZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, PlaneScaleXZ) == 0x0002C8, "Member 'ACombinedTransformGizmoActor::PlaneScaleXZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, PlaneScaleXY) == 0x0002D0, "Member 'ACombinedTransformGizmoActor::PlaneScaleXY' has a wrong offset!");
...
public:
	...
	struct FVector                                ExplicitGridSize;                                  // 0x0048(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRotationGridSizeIsExplicit;                       // 0x0054(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_55[0x3];                                       // 0x0055(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               ExplicitRotationGridSize;                          // 0x0058(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bSnapToWorldRotGrid;                               // 0x0064(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseContextCoordinateSystem;                       // 0x0065(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_66[0x2];                                       // 0x0066(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	EToolContextCoordinateSystem                  CurrentCoordinateSystem;                           // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseContextGizmoMode;                              // 0x006C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EToolContextTransformGizmoMode                ActiveGizmoMode;                                   // 0x006D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6E[0x122];                                     // 0x006E(0x0122)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UPrimitiveComponent*>            ActiveComponents;                                  // 0x0190(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UInteractiveGizmo*>              ActiveGizmos;                                      // 0x01A0(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_1B0[0x50];                                     // 0x01B0(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	class UGizmoConstantFrameAxisSource*          CameraAxisSource;                                  // 0x0200(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              AxisXSource;                                       // 0x0208(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              AxisYSource;                                       // 0x0210(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              AxisZSource;                                       // 0x0218(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              UnitAxisXSource;                                   // 0x0220(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              UnitAxisYSource;                                   // 0x0228(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              UnitAxisZSource;                                   // 0x0230(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoTransformChangeStateTarget*       StateTarget;                                       // 0x0238(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_240[0x110];                                    // 0x0240(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCombinedTransformGizmo) == 0x000350, "Wrong size on UCombinedTransformGizmo");
...
static_assert(offsetof(UCombinedTransformGizmo, bRotationGridSizeIsExplicit) == 0x000054, "Member 'UCombinedTransformGizmo::bRotationGridSizeIsExplicit' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, ExplicitRotationGridSize) == 0x000058, "Member 'UCombinedTransformGizmo::ExplicitRotationGridSize' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, bSnapToWorldRotGrid) == 0x000064, "Member 'UCombinedTransformGizmo::bSnapToWorldRotGrid' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, bUseContextCoordinateSystem) == 0x000065, "Member 'UCombinedTransformGizmo::bUseContextCoordinateSystem' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, CurrentCoordinateSystem) == 0x000068, "Member 'UCombinedTransformGizmo::CurrentCoordinateSystem' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, bUseContextGizmoMode) == 0x00006C, "Member 'UCombinedTransformGizmo::bUseContextGizmoMode' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, ActiveGizmoMode) == 0x00006D, "Member 'UCombinedTransformGizmo::ActiveGizmoMode' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, ActiveComponents) == 0x000190, "Member 'UCombinedTransformGizmo::ActiveComponents' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, ActiveGizmos) == 0x0001A0, "Member 'UCombinedTransformGizmo::ActiveGizmos' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, CameraAxisSource) == 0x000200, "Member 'UCombinedTransformGizmo::CameraAxisSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, AxisXSource) == 0x000208, "Member 'UCombinedTransformGizmo::AxisXSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, AxisYSource) == 0x000210, "Member 'UCombinedTransformGizmo::AxisYSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, AxisZSource) == 0x000218, "Member 'UCombinedTransformGizmo::AxisZSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, UnitAxisXSource) == 0x000220, "Member 'UCombinedTransformGizmo::UnitAxisXSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, UnitAxisYSource) == 0x000228, "Member 'UCombinedTransformGizmo::UnitAxisYSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, UnitAxisZSource) == 0x000230, "Member 'UCombinedTransformGizmo::UnitAxisZSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, StateTarget) == 0x000238, "Member 'UCombinedTransformGizmo::StateTarget' has a wrong offset!");
...
public:
	...
	struct FQuat                                  Rotation;                                          // 0x04B0(0x0010)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bDrawFullCircle;                                   // 0x04B9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOnlyAllowFrontFacingHits;                         // 0x04BA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoCircleComponent, bDrawFullCircle) == 0x0004B9, "Member 'UGizmoCircleComponent::bDrawFullCircle' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bOnlyAllowFrontFacingHits) == 0x0004BA, "Member 'UGizmoCircleComponent::bOnlyAllowFrontFacingHits' has a wrong offset!");
...
public:
	...
	struct FVector                                ViewDependentAxis;                                 // 0x00A0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         ViewDependentAngleTol;                             // 0x00AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         ViewDependentAxialMaxCosAngleTol;                  // 0x00B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         ViewDependentPlanarMinCosAngleTol;                 // 0x00B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EGizmoElementViewAlignType                    ViewAlignType;                                     // 0x00B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                ViewAlignAxis;                                     // 0x00BC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                ViewAlignNormal;                                   // 0x00C8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         ViewAlignAxialAngleTol;                            // 0x00D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         ViewAlignAxialMaxCosAngleTol;                      // 0x00D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PixelHitDistanceThreshold;                         // 0x00DC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementBase) == 0x0000E0, "Wrong size on UGizmoElementBase");
...
static_assert(offsetof(UGizmoElementBase, ViewDependentAngleTol) == 0x0000AC, "Member 'UGizmoElementBase::ViewDependentAngleTol' has a wrong offset!");
static_assert(offsetof(UGizmoElementBase, ViewDependentAxialMaxCosAngleTol) == 0x0000B0, "Member 'UGizmoElementBase::ViewDependentAxialMaxCosAngleTol' has a wrong offset!");
static_assert(offsetof(UGizmoElementBase, ViewDependentPlanarMinCosAngleTol) == 0x0000B4, "Member 'UGizmoElementBase::ViewDependentPlanarMinCosAngleTol' has a wrong offset!");
static_assert(offsetof(UGizmoElementBase, ViewAlignType) == 0x0000B8, "Member 'UGizmoElementBase::ViewAlignType' has a wrong offset!");
static_assert(offsetof(UGizmoElementBase, ViewAlignAxis) == 0x0000BC, "Member 'UGizmoElementBase::ViewAlignAxis' has a wrong offset!");
static_assert(offsetof(UGizmoElementBase, ViewAlignNormal) == 0x0000C8, "Member 'UGizmoElementBase::ViewAlignNormal' has a wrong offset!");
static_assert(offsetof(UGizmoElementBase, ViewAlignAxialAngleTol) == 0x0000D4, "Member 'UGizmoElementBase::ViewAlignAxialAngleTol' has a wrong offset!");
static_assert(offsetof(UGizmoElementBase, ViewAlignAxialMaxCosAngleTol) == 0x0000D8, "Member 'UGizmoElementBase::ViewAlignAxialMaxCosAngleTol' has a wrong offset!");
static_assert(offsetof(UGizmoElementBase, PixelHitDistanceThreshold) == 0x0000DC, "Member 'UGizmoElementBase::PixelHitDistanceThreshold' has a wrong offset!");
...
{
public:
	struct FGizmoElementLineRenderStateAttributes LineRenderAttributes;                              // 0x00E0(0x003C)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	float                                         LineThickness;                                     // 0x011C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bScreenSpaceLine;                                  // 0x0120(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_121[0x3];                                      // 0x0121(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         HoverLineThicknessMultiplier;                      // 0x0124(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         InteractLineThicknessMultiplier;                   // 0x0128(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementLineBase) == 0x000130, "Wrong size on UGizmoElementLineBase");
static_assert(offsetof(UGizmoElementLineBase, LineRenderAttributes) == 0x0000E0, "Member 'UGizmoElementLineBase::LineRenderAttributes' has a wrong offset!");
static_assert(offsetof(UGizmoElementLineBase, LineThickness) == 0x00011C, "Member 'UGizmoElementLineBase::LineThickness' has a wrong offset!");
static_assert(offsetof(UGizmoElementLineBase, bScreenSpaceLine) == 0x000120, "Member 'UGizmoElementLineBase::bScreenSpaceLine' has a wrong offset!");
static_assert(offsetof(UGizmoElementLineBase, HoverLineThicknessMultiplier) == 0x000124, "Member 'UGizmoElementLineBase::HoverLineThicknessMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoElementLineBase, InteractLineThicknessMultiplier) == 0x000128, "Member 'UGizmoElementLineBase::InteractLineThicknessMultiplier' has a wrong offset!");
...
{
public:
	struct FVector                                Center;                                            // 0x0130(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                Axis0;                                             // 0x013C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                Axis1;                                             // 0x0148(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_154[0x4];                                      // 0x0154(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        Radius;                                            // 0x0158(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumSegments;                                       // 0x0160(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EGizmoElementPartialType                      PartialType;                                       // 0x0164(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	double                                        PartialStartAngle;                                 // 0x0168(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	double                                        PartialEndAngle;                                   // 0x0170(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	double                                        PartialViewDependentMaxCosTol;                     // 0x0178(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementCircleBase) == 0x000180, "Wrong size on UGizmoElementCircleBase");
static_assert(offsetof(UGizmoElementCircleBase, Center) == 0x000130, "Member 'UGizmoElementCircleBase::Center' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircleBase, Axis0) == 0x00013C, "Member 'UGizmoElementCircleBase::Axis0' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircleBase, Axis1) == 0x000148, "Member 'UGizmoElementCircleBase::Axis1' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircleBase, Radius) == 0x000158, "Member 'UGizmoElementCircleBase::Radius' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircleBase, NumSegments) == 0x000160, "Member 'UGizmoElementCircleBase::NumSegments' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircleBase, PartialType) == 0x000164, "Member 'UGizmoElementCircleBase::PartialType' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircleBase, PartialStartAngle) == 0x000168, "Member 'UGizmoElementCircleBase::PartialStartAngle' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircleBase, PartialEndAngle) == 0x000170, "Member 'UGizmoElementCircleBase::PartialEndAngle' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircleBase, PartialViewDependentMaxCosTol) == 0x000178, "Member 'UGizmoElementCircleBase::PartialViewDependentMaxCosTol' has a wrong offset!");
...
{
public:
	double                                        InnerRadius;                                       // 0x0180(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementArc) == 0x000188, "Wrong size on UGizmoElementArc");
static_assert(offsetof(UGizmoElementArc, InnerRadius) == 0x000180, "Member 'UGizmoElementArc::InnerRadius' has a wrong offset!");
...
public:
	...
	class UGizmoElementCylinder*                  CylinderElement;                                   // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoElementCone*                      ConeElement;                                       // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoElementBox*                       BoxElement;                                        // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                Base;                                              // 0x0100(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                Direction;                                         // 0x010C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                SideDirection;                                     // 0x0118(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         BodyLength;                                        // 0x0124(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         BodyRadius;                                        // 0x0128(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         HeadLength;                                        // 0x012C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         HeadRadius;                                        // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumSides;                                          // 0x0134(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EGizmoElementArrowHeadType                    HeadType;                                          // 0x0138(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementArrow) == 0x000140, "Wrong size on UGizmoElementArrow");
static_assert(offsetof(UGizmoElementArrow, CylinderElement) == 0x0000E8, "Member 'UGizmoElementArrow::CylinderElement' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, ConeElement) == 0x0000F0, "Member 'UGizmoElementArrow::ConeElement' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, BoxElement) == 0x0000F8, "Member 'UGizmoElementArrow::BoxElement' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, Base) == 0x000100, "Member 'UGizmoElementArrow::Base' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, Direction) == 0x00010C, "Member 'UGizmoElementArrow::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, SideDirection) == 0x000118, "Member 'UGizmoElementArrow::SideDirection' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, BodyLength) == 0x000124, "Member 'UGizmoElementArrow::BodyLength' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, BodyRadius) == 0x000128, "Member 'UGizmoElementArrow::BodyRadius' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, HeadLength) == 0x00012C, "Member 'UGizmoElementArrow::HeadLength' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, HeadRadius) == 0x000130, "Member 'UGizmoElementArrow::HeadRadius' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, NumSides) == 0x000134, "Member 'UGizmoElementArrow::NumSides' has a wrong offset!");
static_assert(offsetof(UGizmoElementArrow, HeadType) == 0x000138, "Member 'UGizmoElementArrow::HeadType' has a wrong offset!");
...
{
public:
	struct FVector                                Center;                                            // 0x00E0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                Dimensions;                                        // 0x00EC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                UpDirection;                                       // 0x00F8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                SideDirection;                                     // 0x0104(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementBox) == 0x000110, "Wrong size on UGizmoElementBox");
static_assert(offsetof(UGizmoElementBox, Center) == 0x0000E0, "Member 'UGizmoElementBox::Center' has a wrong offset!");
static_assert(offsetof(UGizmoElementBox, Dimensions) == 0x0000EC, "Member 'UGizmoElementBox::Dimensions' has a wrong offset!");
static_assert(offsetof(UGizmoElementBox, UpDirection) == 0x0000F8, "Member 'UGizmoElementBox::UpDirection' has a wrong offset!");
static_assert(offsetof(UGizmoElementBox, SideDirection) == 0x000104, "Member 'UGizmoElementBox::SideDirection' has a wrong offset!");
...
{
public:
	bool                                          bDrawMesh;                                         // 0x0180(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDrawLine;                                         // 0x0181(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHitMesh;                                          // 0x0182(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHitLine;                                          // 0x0183(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementCircle) == 0x000188, "Wrong size on UGizmoElementCircle");
static_assert(offsetof(UGizmoElementCircle, bDrawMesh) == 0x000180, "Member 'UGizmoElementCircle::bDrawMesh' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircle, bDrawLine) == 0x000181, "Member 'UGizmoElementCircle::bDrawLine' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircle, bHitMesh) == 0x000182, "Member 'UGizmoElementCircle::bHitMesh' has a wrong offset!");
static_assert(offsetof(UGizmoElementCircle, bHitLine) == 0x000183, "Member 'UGizmoElementCircle::bHitLine' has a wrong offset!");
...
{
public:
	struct FVector                                Origin;                                            // 0x00E0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                Direction;                                         // 0x00EC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Height;                                            // 0x00F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Radius;                                            // 0x00FC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumSides;                                          // 0x0100(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementCone) == 0x000108, "Wrong size on UGizmoElementCone");
static_assert(offsetof(UGizmoElementCone, Origin) == 0x0000E0, "Member 'UGizmoElementCone::Origin' has a wrong offset!");
static_assert(offsetof(UGizmoElementCone, Direction) == 0x0000EC, "Member 'UGizmoElementCone::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoElementCone, Height) == 0x0000F8, "Member 'UGizmoElementCone::Height' has a wrong offset!");
static_assert(offsetof(UGizmoElementCone, Radius) == 0x0000FC, "Member 'UGizmoElementCone::Radius' has a wrong offset!");
static_assert(offsetof(UGizmoElementCone, NumSides) == 0x000100, "Member 'UGizmoElementCone::NumSides' has a wrong offset!");
...
{
public:
	struct FVector                                Base;                                              // 0x00E0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                Direction;                                         // 0x00EC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Height;                                            // 0x00F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Radius;                                            // 0x00FC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumSides;                                          // 0x0100(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementCylinder) == 0x000108, "Wrong size on UGizmoElementCylinder");
static_assert(offsetof(UGizmoElementCylinder, Base) == 0x0000E0, "Member 'UGizmoElementCylinder::Base' has a wrong offset!");
static_assert(offsetof(UGizmoElementCylinder, Direction) == 0x0000EC, "Member 'UGizmoElementCylinder::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoElementCylinder, Height) == 0x0000F8, "Member 'UGizmoElementCylinder::Height' has a wrong offset!");
static_assert(offsetof(UGizmoElementCylinder, Radius) == 0x0000FC, "Member 'UGizmoElementCylinder::Radius' has a wrong offset!");
static_assert(offsetof(UGizmoElementCylinder, NumSides) == 0x000100, "Member 'UGizmoElementCylinder::NumSides' has a wrong offset!");
...
{
public:
	bool                                          bConstantScale;                                    // 0x0130(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHitOwner;                                         // 0x0131(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_132[0x6];                                      // 0x0132(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGizmoElementBase*>              Elements;                                          // 0x0138(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementGroup) == 0x000148, "Wrong size on UGizmoElementGroup");
static_assert(offsetof(UGizmoElementGroup, bConstantScale) == 0x000130, "Member 'UGizmoElementGroup::bConstantScale' has a wrong offset!");
static_assert(offsetof(UGizmoElementGroup, bHitOwner) == 0x000131, "Member 'UGizmoElementGroup::bHitOwner' has a wrong offset!");
static_assert(offsetof(UGizmoElementGroup, Elements) == 0x000138, "Member 'UGizmoElementGroup::Elements' has a wrong offset!");
...
public:
	struct FVector                                Center;                                            // 0x0130(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Width;                                             // 0x013C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	struct FVector                                UpDirection;                                       // 0x0144(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                SideDirection;                                     // 0x0150(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDrawMesh;                                         // 0x015C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDrawLine;                                         // 0x015D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHitMesh;                                          // 0x015E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHitLine;                                          // 0x015F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementRectangle) == 0x000160, "Wrong size on UGizmoElementRectangle");
static_assert(offsetof(UGizmoElementRectangle, Center) == 0x000130, "Member 'UGizmoElementRectangle::Center' has a wrong offset!");
static_assert(offsetof(UGizmoElementRectangle, Width) == 0x00013C, "Member 'UGizmoElementRectangle::Width' has a wrong offset!");
static_assert(offsetof(UGizmoElementRectangle, Height) == 0x000140, "Member 'UGizmoElementRectangle::Height' has a wrong offset!");
static_assert(offsetof(UGizmoElementRectangle, UpDirection) == 0x000144, "Member 'UGizmoElementRectangle::UpDirection' has a wrong offset!");
static_assert(offsetof(UGizmoElementRectangle, SideDirection) == 0x000150, "Member 'UGizmoElementRectangle::SideDirection' has a wrong offset!");
static_assert(offsetof(UGizmoElementRectangle, bDrawMesh) == 0x00015C, "Member 'UGizmoElementRectangle::bDrawMesh' has a wrong offset!");
static_assert(offsetof(UGizmoElementRectangle, bDrawLine) == 0x00015D, "Member 'UGizmoElementRectangle::bDrawLine' has a wrong offset!");
static_assert(offsetof(UGizmoElementRectangle, bHitMesh) == 0x00015E, "Member 'UGizmoElementRectangle::bHitMesh' has a wrong offset!");
static_assert(offsetof(UGizmoElementRectangle, bHitLine) == 0x00015F, "Member 'UGizmoElementRectangle::bHitLine' has a wrong offset!");
...
public:
	double                                        InnerRadius;                                       // 0x0180(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumInnerSlices;                                    // 0x0188(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGizmoElementTorus) == 0x000190, "Wrong size on UGizmoElementTorus");
static_assert(offsetof(UGizmoElementTorus, InnerRadius) == 0x000180, "Member 'UGizmoElementTorus::InnerRadius' has a wrong offset!");
static_assert(offsetof(UGizmoElementTorus, NumInnerSlices) == 0x000188, "Member 'UGizmoElementTorus::NumInnerSlices' has a wrong offset!");
static_assert(offsetof(UGizmoElementTorus, bEndCaps) == 0x00018C, "Member 'UGizmoElementTorus::bEndCaps' has a wrong offset!");
...
public:
	...
	bool                                          bOrientYAccordingToCamera;                         // 0x04B8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4B9[0x3];                                      // 0x04B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OffsetX;                                           // 0x04BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OffsetY;                                           // 0x04C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LengthX;                                           // 0x04C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LengthY;                                           // 0x04C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         SegmentFlags;                                      // 0x04D0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoRectangleComponent, bOrientYAccordingToCamera) == 0x0004B8, "Member 'UGizmoRectangleComponent::bOrientYAccordingToCamera' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetX) == 0x0004BC, "Member 'UGizmoRectangleComponent::OffsetX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetY) == 0x0004C0, "Member 'UGizmoRectangleComponent::OffsetY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthX) == 0x0004C4, "Member 'UGizmoRectangleComponent::LengthX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthY) == 0x0004C8, "Member 'UGizmoRectangleComponent::LengthY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, Thickness) == 0x0004CC, "Member 'UGizmoRectangleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, SegmentFlags) == 0x0004D0, "Member 'UGizmoRectangleComponent::SegmentFlags' has a wrong offset!");
...
static_assert(sizeof(UGizmoViewContext) == 0x000110, "Wrong size on UGizmoViewContext");
...
{
public:
	class UGizmoLineHandleComponent*              UpIntervalComponent;                               // 0x0250(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGizmoLineHandleComponent*              DownIntervalComponent;                             // 0x0258(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGizmoLineHandleComponent*              ForwardIntervalComponent;                          // 0x0260(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AIntervalGizmoActor) == 0x000268, "Wrong size on AIntervalGizmoActor");
static_assert(offsetof(AIntervalGizmoActor, UpIntervalComponent) == 0x000250, "Member 'AIntervalGizmoActor::UpIntervalComponent' has a wrong offset!");
static_assert(offsetof(AIntervalGizmoActor, DownIntervalComponent) == 0x000258, "Member 'AIntervalGizmoActor::DownIntervalComponent' has a wrong offset!");
static_assert(offsetof(AIntervalGizmoActor, ForwardIntervalComponent) == 0x000260, "Member 'AIntervalGizmoActor::ForwardIntervalComponent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_121[0x3];                                      // 0x0121(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                InteractionOrigin;                                 // 0x0124(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionNormal;                                 // 0x0130(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionAxisX;                                  // 0x013C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionAxisY;                                  // 0x0148(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionStartPoint;                             // 0x0154(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                InteractionCurPoint;                               // 0x0160(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              InteractionStartParameter;                         // 0x016C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              InteractionCurParameter;                           // 0x0174(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              ParameterSigns;                                    // 0x017C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPlanePositionGizmo) == 0x0001D0, "Wrong size on UPlanePositionGizmo");
...
static_assert(offsetof(UPlanePositionGizmo, InteractionOrigin) == 0x000124, "Member 'UPlanePositionGizmo::InteractionOrigin' has a wrong offset!");
static_assert(offsetof(UPlanePositionGizmo, InteractionNormal) == 0x000130, "Member 'UPlanePositionGizmo::InteractionNormal' has a wrong offset!");
static_assert(offsetof(UPlanePositionGizmo, InteractionAxisX) == 0x00013C, "Member 'UPlanePositionGizmo::InteractionAxisX' has a wrong offset!");
static_assert(offsetof(UPlanePositionGizmo, InteractionAxisY) == 0x000148, "Member 'UPlanePositionGizmo::InteractionAxisY' has a wrong offset!");
static_assert(offsetof(UPlanePositionGizmo, InteractionStartPoint) == 0x000154, "Member 'UPlanePositionGizmo::InteractionStartPoint' has a wrong offset!");
static_assert(offsetof(UPlanePositionGizmo, InteractionCurPoint) == 0x000160, "Member 'UPlanePositionGizmo::InteractionCurPoint' has a wrong offset!");
static_assert(offsetof(UPlanePositionGizmo, InteractionStartParameter) == 0x00016C, "Member 'UPlanePositionGizmo::InteractionStartParameter' has a wrong offset!");
static_assert(offsetof(UPlanePositionGizmo, InteractionCurParameter) == 0x000174, "Member 'UPlanePositionGizmo::InteractionCurParameter' has a wrong offset!");
static_assert(offsetof(UPlanePositionGizmo, ParameterSigns) == 0x00017C, "Member 'UPlanePositionGizmo::ParameterSigns' has a wrong offset!");
...
public:
	...
	class UGizmoTransformChangeStateTarget*       RepositionStateTarget;                             // 0x03E0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URepositionableTransformGizmo) == 0x0003F0, "Wrong size on URepositionableTransformGizmo");
static_assert(offsetof(URepositionableTransformGizmo, RepositionStateTarget) == 0x0003E0, "Member 'URepositionableTransformGizmo::RepositionStateTarget' has a wrong offset!");
...
static_assert(sizeof(UScalableSphereGizmoInputBehavior) == 0x0000B0, "Wrong size on UScalableSphereGizmoInputBehavior");
...
public:
	...
	struct FTransform                             SharedTransform;                                   // 0x00F0(0x0030)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FTransform                             InitialSharedTransform;                            // 0x0120(0x0030)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UTransformProxy) == 0x000150, "Wrong size on UTransformProxy");
...
static_assert(offsetof(UTransformProxy, InitialSharedTransform) == 0x000120, "Member 'UTransformProxy::InitialSharedTransform' has a wrong offset!");
...
static_assert(sizeof(UMeshSurfacePointTool) == 0x0000E8, "Wrong size on UMeshSurfacePointTool");
static_assert(offsetof(UMeshSurfacePointTool, TargetWorld) == 0x0000E0, "Member 'UMeshSurfacePointTool::TargetWorld' has a wrong offset!");
...
{
public:
	class UBrushBaseProperties*                   BrushProperties;                                   // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FBrushStampData                        LastBrushStamp;                                    // 0x00F8(0x00BC)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B4[0x14];                                     // 0x01B4(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftClassPtr<class UClass>                   PropertyClass;                                     // 0x01C8(0x0030)(Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBrushStampIndicator*                   BrushStampIndicator;                               // 0x01F8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBaseBrushTool) == 0x000200, "Wrong size on UBaseBrushTool");
static_assert(offsetof(UBaseBrushTool, BrushProperties) == 0x0000E8, "Member 'UBaseBrushTool::BrushProperties' has a wrong offset!");
static_assert(offsetof(UBaseBrushTool, bInBrushStroke) == 0x0000F0, "Member 'UBaseBrushTool::bInBrushStroke' has a wrong offset!");
static_assert(offsetof(UBaseBrushTool, WorldToLocalScale) == 0x0000F4, "Member 'UBaseBrushTool::WorldToLocalScale' has a wrong offset!");
static_assert(offsetof(UBaseBrushTool, LastBrushStamp) == 0x0000F8, "Member 'UBaseBrushTool::LastBrushStamp' has a wrong offset!");
static_assert(offsetof(UBaseBrushTool, PropertyClass) == 0x0001C8, "Member 'UBaseBrushTool::PropertyClass' has a wrong offset!");
static_assert(offsetof(UBaseBrushTool, BrushStampIndicator) == 0x0001F8, "Member 'UBaseBrushTool::BrushStampIndicator' has a wrong offset!");
