...
public:
	...
	struct FVector                                MinPos;                                            // 0x003C(0x000C)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                MaxPos;                                            // 0x0048(0x000C)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNetObjectGridFilterConfig, MinPos) == 0x00003C, "Member 'UNetObjectGridFilterConfig::MinPos' has a wrong offset!");
static_assert(offsetof(UNetObjectGridFilterConfig, MaxPos) == 0x000048, "Member 'UNetObjectGridFilterConfig::MaxPos' has a wrong offset!");
