...
{
public:
	struct FTransform                             InWorldTransform;                                  // 0x0000(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBox2D                                 InExtents;                                         // 0x0030(0x0014)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UTextureRenderTarget2D*                 OutRenderTarget;                                   // 0x0048(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(Landscape_RenderHeightmap) == 0x000010, "Wrong alignment on Landscape_RenderHeightmap");
static_assert(sizeof(Landscape_RenderHeightmap) == 0x000050, "Wrong size on Landscape_RenderHeightmap");
...
static_assert(offsetof(Landscape_RenderHeightmap, InExtents) == 0x000030, "Member 'Landscape_RenderHeightmap::InExtents' has a wrong offset!");
static_assert(offsetof(Landscape_RenderHeightmap, OutRenderTarget) == 0x000048, "Member 'Landscape_RenderHeightmap::OutRenderTarget' has a wrong offset!");
...
public:
	...
	class ULandscapeLayerInfoObject*              PaintLayer;                                        // 0x0010(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FTransform                             InLandscapeTransform;                              // 0x0000(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
