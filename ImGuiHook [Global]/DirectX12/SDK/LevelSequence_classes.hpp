...
static_assert(sizeof(ALevelSequenceActor) == 0x0002C8, "Wrong size on ALevelSequenceActor");
static_assert(offsetof(ALevelSequenceActor, PlaybackSettings) == 0x000258, "Member 'ALevelSequenceActor::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, SequencePlayer) == 0x000280, "Member 'ALevelSequenceActor::SequencePlayer' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, LevelSequenceAsset) == 0x000288, "Member 'ALevelSequenceActor::LevelSequenceAsset' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, CameraSettings) == 0x000290, "Member 'ALevelSequenceActor::CameraSettings' has a wrong offset!");
...
static_assert(offsetof(ALevelSequenceActor, bShowBurnin) == 0x0002C0, "Member 'ALevelSequenceActor::bShowBurnin' has a wrong offset!");
...
static_assert(sizeof(ULevelSequencePlayer) == 0x0005F0, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x0004C0, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
...
static_assert(sizeof(AReplicatedLevelSequenceActor) == 0x0002C8, "Wrong size on AReplicatedLevelSequenceActor");
...
static_assert(offsetof(ULevelSequenceBurnIn, FrameInformation) == 0x000250, "Member 'ULevelSequenceBurnIn::FrameInformation' has a wrong offset!");
