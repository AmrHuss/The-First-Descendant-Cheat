...
#include "LinkedStatRatioBased_classes.hpp"
#include "LinkedStatRatioBased_parameters.hpp"
...
struct FM1ScaledInteger ULinkedStatRatioBased_C::CalculateValue(const struct FM1AbilityOpCalcParam& Param) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LinkedStatRatioBased_C", "CalculateValue");

	Params::LinkedStatRatioBased_C_CalculateValue Parms{};
