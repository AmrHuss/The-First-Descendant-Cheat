...
static_assert(sizeof(ULiveLinkInstance) == 0x000320, "Wrong size on ULiveLinkInstance");
static_assert(offsetof(ULiveLinkInstance, CurrentRetargetAsset) == 0x000318, "Member 'ULiveLinkInstance::CurrentRetargetAsset' has a wrong offset!");
