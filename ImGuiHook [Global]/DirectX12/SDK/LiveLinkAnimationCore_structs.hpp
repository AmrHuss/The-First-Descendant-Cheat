...
{
public:
	struct FAnimNode_LiveLinkPose                 PoseNode;                                          // 0x06D8(0x0048)(Edit, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FLiveLinkInstanceProxy, PoseNode) == 0x0006D8, "Member 'FLiveLinkInstanceProxy::PoseNode' has a wrong offset!");
