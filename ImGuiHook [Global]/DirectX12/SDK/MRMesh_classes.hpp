...
public:
	...
	class UMRMeshComponent*                       MRMesh;                                            // 0x0240(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FBodyInstance                          BodyInstance;                                      // 0x0038(0x0158)(Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMRMeshBodyHolder) == 0x0001D8, "Wrong size on UMRMeshBodyHolder");
...
public:
	...
	class UMaterialInterface*                     Material;                                          // 0x0478(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMaterialInterface*                     WireframeMaterial;                                 // 0x0480(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_48A[0x1];                                      // 0x048A(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bNeverCreateCollisionMesh;                         // 0x048B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_48C[0x44];                                     // 0x048C(0x0044)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMRMeshBodyHolder*>              BodyHolders;                                       // 0x04D0(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMRMeshComponent) == 0x0004F0, "Wrong size on UMRMeshComponent");
...
static_assert(offsetof(UMRMeshComponent, bNeverCreateCollisionMesh) == 0x00048B, "Member 'UMRMeshComponent::bNeverCreateCollisionMesh' has a wrong offset!");
static_assert(offsetof(UMRMeshComponent, BodyHolders) == 0x0004D0, "Member 'UMRMeshComponent::BodyHolders' has a wrong offset!");
