...
{
public:
	struct FSoundAttenuationSettings              OutAttenuationSettings;                            // 0x0000(0x03C0)(Parm, OutParm, NativeAccessSpecifierPublic)
...
static_assert(sizeof(MediaSoundComponent_BP_GetAttenuationSettingsToApply) == 0x0003C8, "Wrong size on MediaSoundComponent_BP_GetAttenuationSettingsToApply");
...
static_assert(offsetof(MediaSoundComponent_BP_GetAttenuationSettingsToApply, ReturnValue) == 0x0003C0, "Member 'MediaSoundComponent_BP_GetAttenuationSettingsToApply::ReturnValue' has a wrong offset!");
