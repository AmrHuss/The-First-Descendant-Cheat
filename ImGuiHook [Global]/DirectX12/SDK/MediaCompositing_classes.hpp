...
static_assert(sizeof(UMovieSceneMediaSection) == 0x000150, "Wrong size on UMovieSceneMediaSection");
...
static_assert(offsetof(UMovieSceneMediaSection, MediaSourceProxyBindingID) == 0x000138, "Member 'UMovieSceneMediaSection::MediaSourceProxyBindingID' has a wrong offset!");
