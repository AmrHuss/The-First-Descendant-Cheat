...
static_assert(sizeof(MediaCapture_CaptureActiveSceneViewport) == 0x000020, "Wrong size on MediaCapture_CaptureActiveSceneViewport");
...
static_assert(offsetof(MediaCapture_CaptureActiveSceneViewport, ReturnValue) == 0x00001C, "Member 'MediaCapture_CaptureActiveSceneViewport::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MediaCapture_CaptureTextureRenderTarget2D, ReturnValue) == 0x000024, "Member 'MediaCapture_CaptureTextureRenderTarget2D::ReturnValue' has a wrong offset!");
