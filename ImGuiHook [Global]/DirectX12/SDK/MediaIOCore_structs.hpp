...
static_assert(sizeof(FMediaCaptureOptions) == 0x00001C, "Wrong size on FMediaCaptureOptions");
...
static_assert(offsetof(FMediaCaptureOptions, CapturePhase) == 0x000018, "Member 'FMediaCaptureOptions::CapturePhase' has a wrong offset!");
