...
{
public:
	class UMediaPlateComponent*                   MediaPlateComponent;                               // 0x0248(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AMediaPlate) == 0x000258, "Wrong size on AMediaPlate");
static_assert(offsetof(AMediaPlate, MediaPlateComponent) == 0x000248, "Member 'AMediaPlate::MediaPlateComponent' has a wrong offset!");
static_assert(offsetof(AMediaPlate, StaticMeshComponent) == 0x000250, "Member 'AMediaPlate::StaticMeshComponent' has a wrong offset!");
...
public:
	...
	struct FVector2D                              MeshRange;                                         // 0x010C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMediaPlateComponent, bIsAspectRatioAuto) == 0x0000FC, "Member 'UMediaPlateComponent::bIsAspectRatioAuto' has a wrong offset!");
static_assert(offsetof(UMediaPlateComponent, bEnableMipMapUpscaling) == 0x0000FD, "Member 'UMediaPlateComponent::bEnableMipMapUpscaling' has a wrong offset!");
static_assert(offsetof(UMediaPlateComponent, MipLevelToUpscale) == 0x000100, "Member 'UMediaPlateComponent::MipLevelToUpscale' has a wrong offset!");
...
static_assert(offsetof(UMediaPlateComponent, MeshRange) == 0x00010C, "Member 'UMediaPlateComponent::MeshRange' has a wrong offset!");
