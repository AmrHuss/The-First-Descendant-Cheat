...
{
public:
	struct FVector2D                              InMeshRange;                                       // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlateComponent_SetMeshRange) == 0x000004, "Wrong alignment on MediaPlateComponent_SetMeshRange");
static_assert(sizeof(MediaPlateComponent_SetMeshRange) == 0x000008, "Wrong size on MediaPlateComponent_SetMeshRange");
...
static_assert(alignof(MediaPlateComponent_GetMeshRange) == 0x000004, "Wrong alignment on MediaPlateComponent_GetMeshRange");
static_assert(sizeof(MediaPlateComponent_GetMeshRange) == 0x000008, "Wrong size on MediaPlateComponent_GetMeshRange");
