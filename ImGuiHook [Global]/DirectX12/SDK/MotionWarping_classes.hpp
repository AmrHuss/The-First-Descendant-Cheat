...
public:
	...
	struct FTransform                             StartTransform;                                    // 0x0050(0x0030)(BlueprintVisible, BlueprintReadOnly, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TDelegate<void(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* RootMotionModifier)> OnActivateDelegate;                                // 0x0084(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* RootMotionModifier)> OnUpdateDelegate;                                  // 0x0094(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* RootMotionModifier)> OnDeactivateDelegate;                              // 0x00A4(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URootMotionModifier) == 0x0000C0, "Wrong size on URootMotionModifier");
...
static_assert(offsetof(URootMotionModifier, ActualStartTime) == 0x000080, "Member 'URootMotionModifier::ActualStartTime' has a wrong offset!");
static_assert(offsetof(URootMotionModifier, OnActivateDelegate) == 0x000084, "Member 'URootMotionModifier::OnActivateDelegate' has a wrong offset!");
static_assert(offsetof(URootMotionModifier, OnUpdateDelegate) == 0x000094, "Member 'URootMotionModifier::OnUpdateDelegate' has a wrong offset!");
static_assert(offsetof(URootMotionModifier, OnDeactivateDelegate) == 0x0000A4, "Member 'URootMotionModifier::OnDeactivateDelegate' has a wrong offset!");
static_assert(offsetof(URootMotionModifier, State) == 0x0000B4, "Member 'URootMotionModifier::State' has a wrong offset!");
...
public:
	...
	struct FTransform                             WarpPointAnimTransform;                            // 0x00D0(0x0030)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	EAlphaBlendOption                             AddTranslationEasingFunc;                          // 0x010A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10B[0x5];                                      // 0x010B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveFloat*                            AddTranslationEasingCurve;                         // 0x0110(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWarpRotation;                                     // 0x0118(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMotionWarpRotationType                       RotationType;                                      // 0x0119(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11A[0x2];                                      // 0x011A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WarpRotationTimeMultiplier;                        // 0x011C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTransform                             CachedTargetTransform;                             // 0x0120(0x0030)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URootMotionModifier_Warp) == 0x000190, "Wrong size on URootMotionModifier_Warp");
static_assert(offsetof(URootMotionModifier_Warp, WarpTargetName) == 0x0000B8, "Member 'URootMotionModifier_Warp::WarpTargetName' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, WarpPointAnimProvider) == 0x0000C0, "Member 'URootMotionModifier_Warp::WarpPointAnimProvider' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, WarpPointAnimTransform) == 0x0000D0, "Member 'URootMotionModifier_Warp::WarpPointAnimTransform' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, WarpPointAnimBoneName) == 0x000100, "Member 'URootMotionModifier_Warp::WarpPointAnimBoneName' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, bWarpTranslation) == 0x000108, "Member 'URootMotionModifier_Warp::bWarpTranslation' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, bIgnoreZAxis) == 0x000109, "Member 'URootMotionModifier_Warp::bIgnoreZAxis' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, AddTranslationEasingFunc) == 0x00010A, "Member 'URootMotionModifier_Warp::AddTranslationEasingFunc' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, AddTranslationEasingCurve) == 0x000110, "Member 'URootMotionModifier_Warp::AddTranslationEasingCurve' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, bWarpRotation) == 0x000118, "Member 'URootMotionModifier_Warp::bWarpRotation' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, RotationType) == 0x000119, "Member 'URootMotionModifier_Warp::RotationType' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, WarpRotationTimeMultiplier) == 0x00011C, "Member 'URootMotionModifier_Warp::WarpRotationTimeMultiplier' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, CachedTargetTransform) == 0x000120, "Member 'URootMotionModifier_Warp::CachedTargetTransform' has a wrong offset!");
...
static_assert(sizeof(URootMotionModifier_SimpleWarp) == 0x000190, "Wrong size on URootMotionModifier_SimpleWarp");
...
static_assert(sizeof(URootMotionModifier_Scale) == 0x0000D0, "Wrong size on URootMotionModifier_Scale");
static_assert(offsetof(URootMotionModifier_Scale, Scale) == 0x0000B8, "Member 'URootMotionModifier_Scale::Scale' has a wrong offset!");
...
{
public:
	bool                                          bWarpIKBones;                                      // 0x0190(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_191[0x7];                                      // 0x0191(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           IKBones;                                           // 0x0198(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A8[0x8];                                      // 0x01A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             CachedMeshTransform;                               // 0x01B0(0x0030)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FTransform                             CachedMeshRelativeTransform;                       // 0x01E0(0x0030)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FTransform                             CachedRootMotion;                                  // 0x0210(0x0030)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FAnimSequenceTrackContainer            Result;                                            // 0x0240(0x0020)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URootMotionModifier_AdjustmentBlendWarp) == 0x000260, "Wrong size on URootMotionModifier_AdjustmentBlendWarp");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, bWarpIKBones) == 0x000190, "Member 'URootMotionModifier_AdjustmentBlendWarp::bWarpIKBones' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, IKBones) == 0x000198, "Member 'URootMotionModifier_AdjustmentBlendWarp::IKBones' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshTransform) == 0x0001B0, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedMeshTransform' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshRelativeTransform) == 0x0001E0, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedMeshRelativeTransform' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedRootMotion) == 0x000210, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedRootMotion' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, Result) == 0x000240, "Member 'URootMotionModifier_AdjustmentBlendWarp::Result' has a wrong offset!");
...
static_assert(sizeof(URootMotionModifier_SkewWarp) == 0x000190, "Wrong size on URootMotionModifier_SkewWarp");
