...
{
public:
	struct FMotionWarpingTarget                   WarpTarget;                                        // 0x0000(0x0034)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(MotionWarpingComponent_AddOrUpdateWarpTarget) == 0x000004, "Wrong alignment on MotionWarpingComponent_AddOrUpdateWarpTarget");
static_assert(sizeof(MotionWarpingComponent_AddOrUpdateWarpTarget) == 0x000034, "Wrong size on MotionWarpingComponent_AddOrUpdateWarpTarget");
...
static_assert(sizeof(MotionWarpingComponent_AddOrUpdateWarpTargetFromLocation) == 0x000014, "Wrong size on MotionWarpingComponent_AddOrUpdateWarpTargetFromLocation");
...
static_assert(sizeof(MotionWarpingComponent_AddOrUpdateWarpTargetFromLocationAndRotation) == 0x000020, "Wrong size on MotionWarpingComponent_AddOrUpdateWarpTargetFromLocationAndRotation");
...
static_assert(offsetof(MotionWarpingComponent_AddOrUpdateWarpTargetFromLocationAndRotation, TargetRotation) == 0x000014, "Member 'MotionWarpingComponent_AddOrUpdateWarpTargetFromLocationAndRotation::TargetRotation' has a wrong offset!");
...
public:
	...
	struct FTransform                             TargetTransform;                                   // 0x0010(0x0030)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(MotionWarpingComponent_AddOrUpdateWarpTargetFromTransform) == 0x000040, "Wrong size on MotionWarpingComponent_AddOrUpdateWarpTargetFromTransform");
...
public:
	...
	struct FVector                                InScale;                                           // 0x0018(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class URootMotionModifier_Scale*              ReturnValue;                                       // 0x0028(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(RootMotionModifier_Scale_AddRootMotionModifierScale) == 0x000030, "Wrong size on RootMotionModifier_Scale_AddRootMotionModifierScale");
...
static_assert(offsetof(RootMotionModifier_Scale_AddRootMotionModifierScale, ReturnValue) == 0x000028, "Member 'RootMotionModifier_Scale_AddRootMotionModifierScale::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FTransform                             InWarpPointAnimTransform;                          // 0x0030(0x0030)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class URootMotionModifier_SkewWarp*           ReturnValue;                                       // 0x0070(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp) == 0x000080, "Wrong size on RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp");
...
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, InWarpPointAnimBoneName) == 0x000060, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::InWarpPointAnimBoneName' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, bInWarpTranslation) == 0x000068, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::bInWarpTranslation' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, bInIgnoreZAxis) == 0x000069, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::bInIgnoreZAxis' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, bInWarpRotation) == 0x00006A, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::bInWarpRotation' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, InRotationType) == 0x00006B, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::InRotationType' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, InWarpRotationTimeMultiplier) == 0x00006C, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::InWarpRotationTimeMultiplier' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, ReturnValue) == 0x000070, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::ReturnValue' has a wrong offset!");
