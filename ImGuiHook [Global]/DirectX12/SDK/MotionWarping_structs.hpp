...
static_assert(alignof(FMotionWarpingTarget) == 0x000004, "Wrong alignment on FMotionWarpingTarget");
static_assert(sizeof(FMotionWarpingTarget) == 0x000034, "Wrong size on FMotionWarpingTarget");
...
static_assert(offsetof(FMotionWarpingTarget, Rotation) == 0x000014, "Member 'FMotionWarpingTarget::Rotation' has a wrong offset!");
static_assert(offsetof(FMotionWarpingTarget, Component) == 0x000020, "Member 'FMotionWarpingTarget::Component' has a wrong offset!");
static_assert(offsetof(FMotionWarpingTarget, BoneName) == 0x000028, "Member 'FMotionWarpingTarget::BoneName' has a wrong offset!");
static_assert(offsetof(FMotionWarpingTarget, bFollowComponent) == 0x000030, "Member 'FMotionWarpingTarget::bFollowComponent' has a wrong offset!");
...
static_assert(sizeof(FMotionDeltaTrack) == 0x000048, "Wrong size on FMotionDeltaTrack");
...
static_assert(offsetof(FMotionDeltaTrack, TotalRotation) == 0x00003C, "Member 'FMotionDeltaTrack::TotalRotation' has a wrong offset!");
