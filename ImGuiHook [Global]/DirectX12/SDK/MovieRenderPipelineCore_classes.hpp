...
static_assert(sizeof(AMoviePipelineGameMode) == 0x0002E8, "Wrong size on AMoviePipelineGameMode");
...
static_assert(sizeof(UMovieRenderDebugWidget) == 0x000250, "Wrong size on UMovieRenderDebugWidget");
...
static_assert(sizeof(UMoviePipeline) == 0x0003E0, "Wrong size on UMoviePipeline");
...
static_assert(offsetof(UMoviePipeline, DebugWidgetClass) == 0x0002F0, "Member 'UMoviePipeline::DebugWidgetClass' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, CurrentJob) == 0x0002F8, "Member 'UMoviePipeline::CurrentJob' has a wrong offset!");
...
static_assert(sizeof(UMoviePipelineGameOverrideSetting) == 0x000140, "Wrong size on UMoviePipelineGameOverrideSetting");
