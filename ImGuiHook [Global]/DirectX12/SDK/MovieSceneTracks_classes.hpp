...
static_assert(sizeof(UMovieSceneSkeletalAnimationSection) == 0x000300, "Wrong size on UMovieSceneSkeletalAnimationSection");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartRotationOffset) == 0x00027C, "Member 'UMovieSceneSkeletalAnimationSection::StartRotationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchWithPrevious) == 0x000288, "Member 'UMovieSceneSkeletalAnimationSection::bMatchWithPrevious' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedBoneName) == 0x00028C, "Member 'UMovieSceneSkeletalAnimationSection::MatchedBoneName' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedLocationOffset) == 0x000294, "Member 'UMovieSceneSkeletalAnimationSection::MatchedLocationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedRotationOffset) == 0x0002A0, "Member 'UMovieSceneSkeletalAnimationSection::MatchedRotationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchTranslation) == 0x0002AC, "Member 'UMovieSceneSkeletalAnimationSection::bMatchTranslation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchIncludeZHeight) == 0x0002AD, "Member 'UMovieSceneSkeletalAnimationSection::bMatchIncludeZHeight' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationYaw) == 0x0002AE, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationYaw' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationPitch) == 0x0002AF, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationPitch' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationRoll) == 0x0002B0, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationRoll' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneMaterialParameterSystem) == 0x000358, "Wrong size on UMovieSceneMaterialParameterSystem");
static_assert(offsetof(UMovieSceneMaterialParameterSystem, DoubleBlenderSystem) == 0x000350, "Member 'UMovieSceneMaterialParameterSystem::DoubleBlenderSystem' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneQuaternionBlenderSystem) == 0x0000D8, "Wrong size on UMovieSceneQuaternionBlenderSystem");
...
static_assert(sizeof(UMovieSceneSkeletalAnimationTrack) == 0x000110, "Wrong size on UMovieSceneSkeletalAnimationTrack");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, bBlendFirstChildOfRoot) == 0x000100, "Member 'UMovieSceneSkeletalAnimationTrack::bBlendFirstChildOfRoot' has a wrong offset!");
