...
public:
	...
	struct FVector3f                              Scale;                                             // 0x0020(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMovieSceneSkeletalAnimRootMotionTrackParams) == 0x000050, "Wrong size on FMovieSceneSkeletalAnimRootMotionTrackParams");
