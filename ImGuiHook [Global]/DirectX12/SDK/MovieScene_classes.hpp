...
static_assert(offsetof(UMovieSceneSubSection, PrerollTime_MovieSceneSubSection) == 0x000124, "Member 'UMovieSceneSubSection::PrerollTime_MovieSceneSubSection' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, NetworkMask) == 0x000128, "Member 'UMovieSceneSubSection::NetworkMask' has a wrong offset!");
...
public:
	...
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x02A8(0x0024)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
	...
	struct FMovieSceneSequenceReplProperties      NetSyncProps;                                      // 0x03E8(0x0010)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                                    // 0x03F8(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMovieSceneSequenceTickManager*         TickManager;                                       // 0x0408(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x0004C0, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x0003F8, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, TickManager) == 0x000408, "Member 'UMovieSceneSequencePlayer::TickManager' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEvalTimeSystem) == 0x0000B0, "Wrong size on UMovieSceneEvalTimeSystem");
