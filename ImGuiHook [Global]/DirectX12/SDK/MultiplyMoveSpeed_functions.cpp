...
#include "MultiplyMoveSpeed_classes.hpp"
#include "MultiplyMoveSpeed_parameters.hpp"
...
void UMultiplyMoveSpeed_C::Execute(const struct FM1AbilityOpCalcParam& Param, struct FM1AbilityOpExecCalcOutput& Output) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MultiplyMoveSpeed_C", "Execute");

	Params::MultiplyMoveSpeed_C_Execute Parms{};
