...
static_assert(sizeof(UAnimNotifyState_TimedNiagaraEffect) == 0x000080, "Wrong size on UAnimNotifyState_TimedNiagaraEffect");
...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffect, Scale) == 0x000058, "Member 'UAnimNotifyState_TimedNiagaraEffect::Scale' has a wrong offset!");
...
static_assert(sizeof(UAnimNotifyState_TimedNiagaraEffectAdvanced) == 0x0000F0, "Wrong size on UAnimNotifyState_TimedNiagaraEffectAdvanced");
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffectAdvanced, bEnableNormalizedNotifyProgress) == 0x000080, "Member 'UAnimNotifyState_TimedNiagaraEffectAdvanced::bEnableNormalizedNotifyProgress' has a wrong offset!");
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffectAdvanced, NotifyProgressUserParameter) == 0x000084, "Member 'UAnimNotifyState_TimedNiagaraEffectAdvanced::NotifyProgressUserParameter' has a wrong offset!");
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffectAdvanced, AnimCurves) == 0x000090, "Member 'UAnimNotifyState_TimedNiagaraEffectAdvanced::AnimCurves' has a wrong offset!");
