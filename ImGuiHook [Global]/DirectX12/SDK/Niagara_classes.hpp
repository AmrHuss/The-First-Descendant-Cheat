...
{
public:
	class UNiagaraSystem*                         Asset;                                             // 0x0470(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraTickBehavior                          TickBehavior;                                      // 0x0478(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_479[0x3];                                      // 0x0479(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RandomSeedOffset;                                  // 0x047C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FNiagaraUserRedirectionParameterStore  OverrideParameters;                                // 0x0480(0x00D8)(NativeAccessSpecifierPrivate)
	...
	uint8                                         bOverrideWarmupSettings : 1;                       // 0x0558(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_559[0x3];                                      // 0x0559(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WarmupTickCount;                                   // 0x055C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         WarmupTickDelta;                                   // 0x0560(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	FMulticastInlineDelegateProperty_             OnSystemFinished;                                  // 0x05A8(0x0010)(ZeroConstructor, InstancedReference, DuplicateTransient, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_5CB[0x9];                                      // 0x05CB(0x0009)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_5D4_0 : 4;                                  // 0x05D4(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bAllowScalability : 1;                             // 0x05D4(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_5D5[0xD3];                                     // 0x05D5(0x00D3)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraSimCache*                       SimCache;                                          // 0x06A8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UNiagaraCullProxyComponent*             CullProxy;                                         // 0x06B0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraComponent) == 0x0006C0, "Wrong size on UNiagaraComponent");
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000470, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x000478, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x00047C, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000480, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickCount) == 0x00055C, "Member 'UNiagaraComponent::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickDelta) == 0x000560, "Member 'UNiagaraComponent::WarmupTickDelta' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, SimCache) == 0x0006A8, "Member 'UNiagaraComponent::SimCache' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x0006B0, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
{
public:
	TArray<struct FNiagaraCulledComponentInfo>    Instances;                                         // 0x06B8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x0006D0, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x0006B8, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataChannel, GameDataLayout) == 0x0000D8, "Member 'UNiagaraDataChannel::GameDataLayout' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceDataChannelSpawn) == 0x0000C0, "Wrong size on UNiagaraDataInterfaceDataChannelSpawn");
static_assert(offsetof(UNiagaraDataInterfaceDataChannelSpawn, EmitterBinding) == 0x0000B0, "Member 'UNiagaraDataInterfaceDataChannelSpawn::EmitterBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceDataChannelSpawn, bOverrideSpawnGroupToDataChannelIndex) == 0x0000BC, "Member 'UNiagaraDataInterfaceDataChannelSpawn::bOverrideSpawnGroupToDataChannelIndex' has a wrong offset!");
...
// Class Niagara.NiagaraDataInterfaceVectorFieldAsWindMotor
// 0x0048 (0x0080 - 0x0038)
class UNiagaraDataInterfaceVectorFieldAsWindMotor final : public UNiagaraDataInterface
{
public:
	class UVectorField*                           Field;                                             // 0x0038(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FQuat                                  FieldRotate;                                       // 0x0050(0x0010)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                FieldScale;                                        // 0x0060(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Intensity;                                         // 0x006C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Tightness;                                         // 0x0070(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_74[0xC];                                       // 0x0074(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"NiagaraDataInterfaceVectorFieldAsWindMotor">();
	}
	static class UNiagaraDataInterfaceVectorFieldAsWindMotor* GetDefaultObj()
	{
		return GetDefaultObjImpl<UNiagaraDataInterfaceVectorFieldAsWindMotor>();
	}
};
static_assert(alignof(UNiagaraDataInterfaceVectorFieldAsWindMotor) == 0x000010, "Wrong alignment on UNiagaraDataInterfaceVectorFieldAsWindMotor");
static_assert(sizeof(UNiagaraDataInterfaceVectorFieldAsWindMotor) == 0x000080, "Wrong size on UNiagaraDataInterfaceVectorFieldAsWindMotor");
static_assert(offsetof(UNiagaraDataInterfaceVectorFieldAsWindMotor, Field) == 0x000038, "Member 'UNiagaraDataInterfaceVectorFieldAsWindMotor::Field' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceVectorFieldAsWindMotor, bTileX) == 0x000040, "Member 'UNiagaraDataInterfaceVectorFieldAsWindMotor::bTileX' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceVectorFieldAsWindMotor, bTileY) == 0x000041, "Member 'UNiagaraDataInterfaceVectorFieldAsWindMotor::bTileY' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceVectorFieldAsWindMotor, bTileZ) == 0x000042, "Member 'UNiagaraDataInterfaceVectorFieldAsWindMotor::bTileZ' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceVectorFieldAsWindMotor, FieldRotate) == 0x000050, "Member 'UNiagaraDataInterfaceVectorFieldAsWindMotor::FieldRotate' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceVectorFieldAsWindMotor, FieldScale) == 0x000060, "Member 'UNiagaraDataInterfaceVectorFieldAsWindMotor::FieldScale' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceVectorFieldAsWindMotor, Intensity) == 0x00006C, "Member 'UNiagaraDataInterfaceVectorFieldAsWindMotor::Intensity' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceVectorFieldAsWindMotor, Tightness) == 0x000070, "Member 'UNiagaraDataInterfaceVectorFieldAsWindMotor::Tightness' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSettings, SimCacheAuxiliaryFileBasePath) == 0x0000F8, "Member 'UNiagaraSettings::SimCacheAuxiliaryFileBasePath' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, SimCacheMaxCPUMemoryVolumetrics) == 0x000108, "Member 'UNiagaraSettings::SimCacheMaxCPUMemoryVolumetrics' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, PlatformSetRedirects) == 0x000110, "Member 'UNiagaraSettings::PlatformSetRedirects' has a wrong offset!");
...
public:
	...
	struct FBox                                   DefaultBounds;                                     // 0x006C(0x001C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceDynamicMesh) == 0x000088, "Wrong size on UNiagaraDataInterfaceDynamicMesh");
...
static_assert(offsetof(UNiagaraDataInterfaceDynamicMesh, DefaultBounds) == 0x00006C, "Member 'UNiagaraDataInterfaceDynamicMesh::DefaultBounds' has a wrong offset!");
...
public:
	...
	int32                                         LODIndex;                                          // 0x0094(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, bAllowSamplingFromStreamingLODs) == 0x000091, "Member 'UNiagaraDataInterfaceStaticMesh::bAllowSamplingFromStreamingLODs' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, LODIndex) == 0x000094, "Member 'UNiagaraDataInterfaceStaticMesh::LODIndex' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, LODIndexUserParameter) == 0x000098, "Member 'UNiagaraDataInterfaceStaticMesh::LODIndexUserParameter' has a wrong offset!");
...
{
public:
	class UNiagaraComponent*                      NiagaraComponent;                                  // 0x0248(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FVector                                CameraViewportLocation[0x7];                       // 0x0084(0x000C)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               CameraViewportRotation[0x7];                       // 0x00D8(0x000C)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         CameraOrbitDistance;                               // 0x012C(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CameraFOV;                                         // 0x0130(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CameraOrthoWidth;                                  // 0x0134(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bUseCameraAspectRatio : 1;                         // 0x0138(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_139[0x3];                                      // 0x0139(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CameraAspectRatio;                                 // 0x013C(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraBakerSettings) == 0x000140, "Wrong size on UNiagaraBakerSettings");
...
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportLocation) == 0x000084, "Member 'UNiagaraBakerSettings::CameraViewportLocation' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportRotation) == 0x0000D8, "Member 'UNiagaraBakerSettings::CameraViewportRotation' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraOrbitDistance) == 0x00012C, "Member 'UNiagaraBakerSettings::CameraOrbitDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraFOV) == 0x000130, "Member 'UNiagaraBakerSettings::CameraFOV' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraOrthoWidth) == 0x000134, "Member 'UNiagaraBakerSettings::CameraOrthoWidth' has a wrong offset!");
static_assert(offsetof(UNiagaraBakerSettings, CameraAspectRatio) == 0x00013C, "Member 'UNiagaraBakerSettings::CameraAspectRatio' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoundAttenuationSettings              AttenuationSettings;                               // 0x0040(0x03C0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceAudioPlayerSettings) == 0x000400, "Wrong size on UNiagaraDataInterfaceAudioPlayerSettings");
...
public:
	...
	struct FVector2D                              WorldBBoxSize;                                     // 0x0050(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceGrid2D) == 0x000058, "Wrong size on UNiagaraDataInterfaceGrid2D");
...
static_assert(offsetof(UNiagaraDataInterfaceGrid2DCollection, RenderTargetUserParameter) == 0x000058, "Member 'UNiagaraDataInterfaceGrid2DCollection::RenderTargetUserParameter' has a wrong offset!");
...
public:
	...
	struct FVector                                WorldBBoxSize;                                     // 0x0054(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceGrid3D) == 0x000060, "Wrong size on UNiagaraDataInterfaceGrid3D");
...
static_assert(offsetof(UNiagaraDataInterfaceGrid3D, WorldBBoxSize) == 0x000054, "Member 'UNiagaraDataInterfaceGrid3D::WorldBBoxSize' has a wrong offset!");
...
{
public:
	int32                                         NumAttributes;                                     // 0x0060(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraDataInterfaceGrid3DCollection, NumAttributes) == 0x000060, "Member 'UNiagaraDataInterfaceGrid3DCollection::NumAttributes' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceGrid3DCollection, RenderTargetUserParameter) == 0x000068, "Member 'UNiagaraDataInterfaceGrid3DCollection::RenderTargetUserParameter' has a wrong offset!");
...
{
public:
	uint32                                        MaxNeighborsPerCell;                               // 0x0060(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraDataInterfaceNeighborGrid3D) == 0x000068, "Wrong size on UNiagaraDataInterfaceNeighborGrid3D");
static_assert(offsetof(UNiagaraDataInterfaceNeighborGrid3D, MaxNeighborsPerCell) == 0x000060, "Member 'UNiagaraDataInterfaceNeighborGrid3D::MaxNeighborsPerCell' has a wrong offset!");
...
{
public:
	int32                                         NumAttributes;                                     // 0x0060(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Precision;                                         // 0x0064(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ResetValue;                                        // 0x0068(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraDataInterfaceRasterizationGrid3D, NumAttributes) == 0x000060, "Member 'UNiagaraDataInterfaceRasterizationGrid3D::NumAttributes' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceRasterizationGrid3D, Precision) == 0x000064, "Member 'UNiagaraDataInterfaceRasterizationGrid3D::Precision' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceRasterizationGrid3D, ResetValue) == 0x000068, "Member 'UNiagaraDataInterfaceRasterizationGrid3D::ResetValue' has a wrong offset!");
...
public:
	...
	TMap<uint64, class UTextureRenderTargetVolume*> ManagedRenderTargets;                              // 0x0070(0x0050)(Transient, DuplicateTransient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UNiagaraDataInterfaceRenderTargetVolume) == 0x0000C0, "Wrong size on UNiagaraDataInterfaceRenderTargetVolume");
...
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetVolume, ManagedRenderTargets) == 0x000070, "Member 'UNiagaraDataInterfaceRenderTargetVolume::ManagedRenderTargets' has a wrong offset!");
...
public:
	...
	struct FNiagaraDebugHUDSettingsData           Data;                                              // 0x0048(0x01F0)(Edit, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDebugHUDSettings) == 0x000238, "Wrong size on UNiagaraDebugHUDSettings");
static_assert(offsetof(UNiagaraDebugHUDSettings, Data) == 0x000048, "Member 'UNiagaraDebugHUDSettings::Data' has a wrong offset!");

// Class Niagara.NiagaraDecalRendererLegacyProperties
// 0x0230 (0x0310 - 0x00E0)
class UNiagaraDecalRendererLegacyProperties final : public UNiagaraRendererProperties
{
public:
	class UMaterialInterface*                     DecalMaterial;                                     // 0x00E0(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraUserParameterBinding           MaterialUserParamBinding;                          // 0x00E8(0x0020)(Edit, NativeAccessSpecifierPublic)
	float                                         FadeScreenSize;                                    // 0x0108(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10C[0x4];                                      // 0x010C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0110(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DecalOrientationBinding;                           // 0x0168(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ScaleBinding;                                      // 0x01C0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterialBinding;                            // 0x0218(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x0270(0x0058)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraMaterialAttributeBinding> MaterialParameterBindings;                         // 0x02C8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D8[0x38];                                     // 0x02D8(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"NiagaraDecalRendererLegacyProperties">();
	}
	static class UNiagaraDecalRendererLegacyProperties* GetDefaultObj()
	{
		return GetDefaultObjImpl<UNiagaraDecalRendererLegacyProperties>();
	}
};
static_assert(alignof(UNiagaraDecalRendererLegacyProperties) == 0x000008, "Wrong alignment on UNiagaraDecalRendererLegacyProperties");
static_assert(sizeof(UNiagaraDecalRendererLegacyProperties) == 0x000310, "Wrong size on UNiagaraDecalRendererLegacyProperties");
static_assert(offsetof(UNiagaraDecalRendererLegacyProperties, DecalMaterial) == 0x0000E0, "Member 'UNiagaraDecalRendererLegacyProperties::DecalMaterial' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererLegacyProperties, MaterialUserParamBinding) == 0x0000E8, "Member 'UNiagaraDecalRendererLegacyProperties::MaterialUserParamBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererLegacyProperties, FadeScreenSize) == 0x000108, "Member 'UNiagaraDecalRendererLegacyProperties::FadeScreenSize' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererLegacyProperties, PositionBinding) == 0x000110, "Member 'UNiagaraDecalRendererLegacyProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererLegacyProperties, DecalOrientationBinding) == 0x000168, "Member 'UNiagaraDecalRendererLegacyProperties::DecalOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererLegacyProperties, ScaleBinding) == 0x0001C0, "Member 'UNiagaraDecalRendererLegacyProperties::ScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererLegacyProperties, DynamicMaterialBinding) == 0x000218, "Member 'UNiagaraDecalRendererLegacyProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererLegacyProperties, NormalizedAgeBinding) == 0x000270, "Member 'UNiagaraDecalRendererLegacyProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererLegacyProperties, MaterialParameterBindings) == 0x0002C8, "Member 'UNiagaraDecalRendererLegacyProperties::MaterialParameterBindings' has a wrong offset!");

// Class Niagara.NiagaraDecalRendererProperties
// 0x0368 (0x0448 - 0x00E0)
...
static_assert(sizeof(UNiagaraDecalRendererProperties) == 0x000448, "Wrong size on UNiagaraDecalRendererProperties");
static_assert(offsetof(UNiagaraDecalRendererProperties, Material) == 0x0000E0, "Member 'UNiagaraDecalRendererProperties::Material' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, MaterialParameterBinding) == 0x0000E8, "Member 'UNiagaraDecalRendererProperties::MaterialParameterBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, SourceMode) == 0x0000F4, "Member 'UNiagaraDecalRendererProperties::SourceMode' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, RendererVisibility) == 0x0000F8, "Member 'UNiagaraDecalRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalScreenSizeFade) == 0x0000FC, "Member 'UNiagaraDecalRendererProperties::DecalScreenSizeFade' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, PositionBinding) == 0x000100, "Member 'UNiagaraDecalRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalOrientationBinding) == 0x000158, "Member 'UNiagaraDecalRendererProperties::DecalOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalSizeBinding) == 0x0001B0, "Member 'UNiagaraDecalRendererProperties::DecalSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalFadeBinding) == 0x000208, "Member 'UNiagaraDecalRendererProperties::DecalFadeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalSortOrderBinding) == 0x000260, "Member 'UNiagaraDecalRendererProperties::DecalSortOrderBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalColorBinding) == 0x0002B8, "Member 'UNiagaraDecalRendererProperties::DecalColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalVisibleBinding) == 0x000310, "Member 'UNiagaraDecalRendererProperties::DecalVisibleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, RendererVisibilityTagBinding) == 0x000368, "Member 'UNiagaraDecalRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, MaterialParameters) == 0x0003C0, "Member 'UNiagaraDecalRendererProperties::MaterialParameters' has a wrong offset!");
...
public:
	...
	struct FTransform                             DesiredRelativeTransform;                          // 0x0260(0x0030)(Edit, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         BaseAuthoredFOV;                                   // 0x0290(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bAllowMultipleInstances : 1;                       // 0x0294(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bResetWhenRetriggered : 1;                         // 0x0294(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_295[0x3];                                      // 0x0295(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class AActor>>             EmittersToTreatAsSame;                             // 0x0298(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class APlayerCameraManager*                   OwningCameraManager;                               // 0x02A8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ANiagaraLensEffectBase) == 0x0002B0, "Wrong size on ANiagaraLensEffectBase");
static_assert(offsetof(ANiagaraLensEffectBase, DesiredRelativeTransform) == 0x000260, "Member 'ANiagaraLensEffectBase::DesiredRelativeTransform' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, BaseAuthoredFOV) == 0x000290, "Member 'ANiagaraLensEffectBase::BaseAuthoredFOV' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, EmittersToTreatAsSame) == 0x000298, "Member 'ANiagaraLensEffectBase::EmittersToTreatAsSame' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, OwningCameraManager) == 0x0002A8, "Member 'ANiagaraLensEffectBase::OwningCameraManager' has a wrong offset!");
...
public:
	...
	uint8                                         bUseInverseSquaredFalloff : 1;                     // 0x00E4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectsTranslucency : 1;                          // 0x00E4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAlphaScalesBrightness : 1;                        // 0x00E4(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideInverseExposureBlend : 1;                 // 0x00E4(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	int32                                         RendererVisibility;                                // 0x0100(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraLightRendererProperties) == 0x0003A0, "Wrong size on UNiagaraLightRendererProperties");
static_assert(offsetof(UNiagaraLightRendererProperties, SourceMode) == 0x0000E0, "Member 'UNiagaraLightRendererProperties::SourceMode' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RadiusScale) == 0x0000E8, "Member 'UNiagaraLightRendererProperties::RadiusScale' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, DefaultExponent) == 0x0000EC, "Member 'UNiagaraLightRendererProperties::DefaultExponent' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, ColorAdd) == 0x0000F0, "Member 'UNiagaraLightRendererProperties::ColorAdd' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, InverseExposureBlend) == 0x0000FC, "Member 'UNiagaraLightRendererProperties::InverseExposureBlend' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibility) == 0x000100, "Member 'UNiagaraLightRendererProperties::RendererVisibility' has a wrong offset!");
...
static_assert(offsetof(UNiagaraLightRendererProperties, LightExponentBinding) == 0x000160, "Member 'UNiagaraLightRendererProperties::LightExponentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, PositionBinding) == 0x0001B8, "Member 'UNiagaraLightRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, ColorBinding) == 0x000210, "Member 'UNiagaraLightRendererProperties::ColorBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraLightRendererProperties, VolumetricScatteringBinding) == 0x0002C0, "Member 'UNiagaraLightRendererProperties::VolumetricScatteringBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibilityTagBinding) == 0x000318, "Member 'UNiagaraLightRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");

// Class Niagara.NiagaraMeshRendererProperties
// 0x0880 (0x0960 - 0x00E0)
...
public:
	...
	uint8                                         bUseHeterogeneousVolumes : 1;                      // 0x00F4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSortOnlyWhenTranslucent : 1;                      // 0x00F4(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_F5[0x3];                                       // 0x00F5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FVector2D                              SubImageSize;                                      // 0x0120(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bLockedAxisEnable : 1;                             // 0x012C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_12D[0x3];                                      // 0x012D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                LockedAxis;                                        // 0x0130(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraMeshLockedAxisSpace                   LockedAxisSpace;                                   // 0x013C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_13D[0x3];                                      // 0x013D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                MeshBoundsScale;                                   // 0x0140(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FNiagaraVariableAttributeBinding       MeshOrientationBinding;                            // 0x0260(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ScaleBinding;                                      // 0x02B8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SubImageIndexBinding;                              // 0x0310(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterialBinding;                            // 0x0368(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial1Binding;                           // 0x03C0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial2Binding;                           // 0x0418(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial3Binding;                           // 0x0470(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x04C8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CustomSortingBinding;                              // 0x0520(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x0578(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CameraOffsetBinding;                               // 0x05D0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0628(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MeshIndexBinding;                                  // 0x0680(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraRendererMaterialParameters     MaterialParameters;                                // 0x06D8(0x0050)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x0728(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevScaleBinding;                                  // 0x0780(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevMeshOrientationBinding;                        // 0x07D8(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevCameraOffsetBinding;                           // 0x0830(0x0058)(Transient, NativeAccessSpecifierPublic)
	...
	class UStaticMesh*                            ParticleMesh;                                      // 0x0948(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                PivotOffset;                                       // 0x0950(0x000C)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraMeshPivotOffsetSpace                  PivotOffsetSpace;                                  // 0x095C(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraMeshRendererProperties) == 0x000960, "Wrong size on UNiagaraMeshRendererProperties");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, MICOverrideMaterials) == 0x000110, "Member 'UNiagaraMeshRendererProperties::MICOverrideMaterials' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageSize) == 0x000120, "Member 'UNiagaraMeshRendererProperties::SubImageSize' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, FacingMode) == 0x000128, "Member 'UNiagaraMeshRendererProperties::FacingMode' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxis) == 0x000130, "Member 'UNiagaraMeshRendererProperties::LockedAxis' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxisSpace) == 0x00013C, "Member 'UNiagaraMeshRendererProperties::LockedAxisSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshBoundsScale) == 0x000140, "Member 'UNiagaraMeshRendererProperties::MeshBoundsScale' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MinCameraDistance) == 0x00014C, "Member 'UNiagaraMeshRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaxCameraDistance) == 0x000150, "Member 'UNiagaraMeshRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibility) == 0x000154, "Member 'UNiagaraMeshRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PositionBinding) == 0x000158, "Member 'UNiagaraMeshRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ColorBinding) == 0x0001B0, "Member 'UNiagaraMeshRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, VelocityBinding) == 0x000208, "Member 'UNiagaraMeshRendererProperties::VelocityBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, ScaleBinding) == 0x0002B8, "Member 'UNiagaraMeshRendererProperties::ScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageIndexBinding) == 0x000310, "Member 'UNiagaraMeshRendererProperties::SubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterialBinding) == 0x000368, "Member 'UNiagaraMeshRendererProperties::DynamicMaterialBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial2Binding) == 0x000418, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial3Binding) == 0x000470, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialRandomBinding) == 0x0004C8, "Member 'UNiagaraMeshRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CustomSortingBinding) == 0x000520, "Member 'UNiagaraMeshRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, NormalizedAgeBinding) == 0x000578, "Member 'UNiagaraMeshRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CameraOffsetBinding) == 0x0005D0, "Member 'UNiagaraMeshRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibilityTagBinding) == 0x000628, "Member 'UNiagaraMeshRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshIndexBinding) == 0x000680, "Member 'UNiagaraMeshRendererProperties::MeshIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialParameters) == 0x0006D8, "Member 'UNiagaraMeshRendererProperties::MaterialParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevPositionBinding) == 0x000728, "Member 'UNiagaraMeshRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevScaleBinding) == 0x000780, "Member 'UNiagaraMeshRendererProperties::PrevScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevMeshOrientationBinding) == 0x0007D8, "Member 'UNiagaraMeshRendererProperties::PrevMeshOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevCameraOffsetBinding) == 0x000830, "Member 'UNiagaraMeshRendererProperties::PrevCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevVelocityBinding) == 0x000888, "Member 'UNiagaraMeshRendererProperties::PrevVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ParticleMesh) == 0x000948, "Member 'UNiagaraMeshRendererProperties::ParticleMesh' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffset) == 0x000950, "Member 'UNiagaraMeshRendererProperties::PivotOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffsetSpace) == 0x00095C, "Member 'UNiagaraMeshRendererProperties::PivotOffsetSpace' has a wrong offset!");
...
{
public:
	class UNiagaraBaselineController*             Controller;                                        // 0x0248(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTextRenderComponent*                   Label;                                             // 0x0250(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class UNiagaraSystem*                         System;                                            // 0x0248(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UNiagaraPreviewAxis*                    PreviewAxisX;                                      // 0x0258(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraPreviewAxis*                    PreviewAxisY;                                      // 0x0260(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ANiagaraPreviewBase>        PreviewClass;                                      // 0x0268(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<class UChildActorComponent*>           PreviewComponents;                                 // 0x0280(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FNiagaraRibbonUVSettings               UV0Settings;                                       // 0x010C(0x0024)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FNiagaraRibbonUVSettings               UV1Settings;                                       // 0x0130(0x0024)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	bool                                          bUseGPUInit;                                       // 0x0158(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRibbonDrawDirection                   DrawDirection;                                     // 0x0159(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRibbonShapeMode                       Shape;                                             // 0x015A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableAccurateGeometry;                           // 0x015B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bUseConstantFactor;                                // 0x0184(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_185[0x3];                                      // 0x0185(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TessellationAngle;                                 // 0x0188(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bScreenSpaceTessellation;                          // 0x018C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_18D[0x3];                                      // 0x018D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0190(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x01E8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VelocityBinding;                                   // 0x0240(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x0298(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonTwistBinding;                                // 0x02F0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonWidthBinding;                                // 0x0348(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonFacingBinding;                               // 0x03A0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonIdBinding;                                   // 0x03F8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonLinkOrderBinding;                            // 0x0450(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x04A8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterialBinding;                            // 0x0500(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial1Binding;                           // 0x0558(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial2Binding;                           // 0x05B0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial3Binding;                           // 0x0608(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RibbonUVDistance;                                  // 0x0660(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       U0OverrideBinding;                                 // 0x06B8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       V0RangeOverrideBinding;                            // 0x0710(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       U1OverrideBinding;                                 // 0x0768(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       V1RangeOverrideBinding;                            // 0x07C0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraRendererMaterialParameters     MaterialParameters;                                // 0x0818(0x0050)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x0868(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevRibbonWidthBinding;                            // 0x08C0(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevRibbonFacingBinding;                           // 0x0918(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevRibbonTwistBinding;                            // 0x0970(0x0058)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C8[0xA8];                                     // 0x09C8(0x00A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraRibbonRendererProperties) == 0x000A70, "Wrong size on UNiagaraRibbonRendererProperties");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, UV0Settings) == 0x00010C, "Member 'UNiagaraRibbonRendererProperties::UV0Settings' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, UV1Settings) == 0x000130, "Member 'UNiagaraRibbonRendererProperties::UV1Settings' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseGPUInit) == 0x000158, "Member 'UNiagaraRibbonRendererProperties::bUseGPUInit' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DrawDirection) == 0x000159, "Member 'UNiagaraRibbonRendererProperties::DrawDirection' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, Shape) == 0x00015A, "Member 'UNiagaraRibbonRendererProperties::Shape' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bEnableAccurateGeometry) == 0x00015B, "Member 'UNiagaraRibbonRendererProperties::bEnableAccurateGeometry' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseConstantFactor) == 0x000184, "Member 'UNiagaraRibbonRendererProperties::bUseConstantFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationAngle) == 0x000188, "Member 'UNiagaraRibbonRendererProperties::TessellationAngle' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bScreenSpaceTessellation) == 0x00018C, "Member 'UNiagaraRibbonRendererProperties::bScreenSpaceTessellation' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PositionBinding) == 0x000190, "Member 'UNiagaraRibbonRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, ColorBinding) == 0x0001E8, "Member 'UNiagaraRibbonRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, VelocityBinding) == 0x000240, "Member 'UNiagaraRibbonRendererProperties::VelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, NormalizedAgeBinding) == 0x000298, "Member 'UNiagaraRibbonRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonTwistBinding) == 0x0002F0, "Member 'UNiagaraRibbonRendererProperties::RibbonTwistBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonFacingBinding) == 0x0003A0, "Member 'UNiagaraRibbonRendererProperties::RibbonFacingBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonLinkOrderBinding) == 0x000450, "Member 'UNiagaraRibbonRendererProperties::RibbonLinkOrderBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialRandomBinding) == 0x0004A8, "Member 'UNiagaraRibbonRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterialBinding) == 0x000500, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial1Binding) == 0x000558, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial2Binding) == 0x0005B0, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial3Binding) == 0x000608, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonUVDistance) == 0x000660, "Member 'UNiagaraRibbonRendererProperties::RibbonUVDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U0OverrideBinding) == 0x0006B8, "Member 'UNiagaraRibbonRendererProperties::U0OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V0RangeOverrideBinding) == 0x000710, "Member 'UNiagaraRibbonRendererProperties::V0RangeOverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U1OverrideBinding) == 0x000768, "Member 'UNiagaraRibbonRendererProperties::U1OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V1RangeOverrideBinding) == 0x0007C0, "Member 'UNiagaraRibbonRendererProperties::V1RangeOverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialParameters) == 0x000818, "Member 'UNiagaraRibbonRendererProperties::MaterialParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevPositionBinding) == 0x000868, "Member 'UNiagaraRibbonRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevRibbonWidthBinding) == 0x0008C0, "Member 'UNiagaraRibbonRendererProperties::PrevRibbonWidthBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevRibbonFacingBinding) == 0x000918, "Member 'UNiagaraRibbonRendererProperties::PrevRibbonFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PrevRibbonTwistBinding) == 0x000970, "Member 'UNiagaraRibbonRendererProperties::PrevRibbonTwistBinding' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UNiagaraSystem>          SoftNiagaraSystem;                                 // 0x0038(0x0030)(Edit, EditConst, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraSimCache) == 0x000200, "Wrong size on UNiagaraSimCache");
...
static_assert(offsetof(UNiagaraSimCache, StartSeconds) == 0x000068, "Member 'UNiagaraSimCache::StartSeconds' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, DurationSeconds) == 0x00006C, "Member 'UNiagaraSimCache::DurationSeconds' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, CreateParameters) == 0x000070, "Member 'UNiagaraSimCache::CreateParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, bNeedsReadComponentMappingRecache) == 0x0000C8, "Member 'UNiagaraSimCache::bNeedsReadComponentMappingRecache' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, CacheLayout) == 0x0000D0, "Member 'UNiagaraSimCache::CacheLayout' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, CacheFrames) == 0x000198, "Member 'UNiagaraSimCache::CacheFrames' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, DataInterfaceStorage) == 0x0001A8, "Member 'UNiagaraSimCache::DataInterfaceStorage' has a wrong offset!");
...
static_assert(sizeof(UAsyncNiagaraCaptureSimCache) == 0x000108, "Wrong size on UAsyncNiagaraCaptureSimCache");
...
public:
	...
	uint8                                         bDisablePartialParticleUpdate : 1;                 // 0x00FC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_FD[0x3];                                       // 0x00FD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableDataInterfaceBinding   DataInterface;                                     // 0x0100(0x0020)(Edit, NativeAccessSpecifierPublic)
	uint8                                         bParticleIterationStateEnabled : 1;                // 0x0120(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         bGpuDispatchForceLinear : 1;                       // 0x0188(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideGpuDispatchNumThreads : 1;                // 0x0188(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UNiagaraSimulationStageGeneric) == 0x0002A8, "Wrong size on UNiagaraSimulationStageGeneric");
...
static_assert(offsetof(UNiagaraSimulationStageGeneric, ExecuteBehavior) == 0x0000F8, "Member 'UNiagaraSimulationStageGeneric::ExecuteBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, DataInterface) == 0x000100, "Member 'UNiagaraSimulationStageGeneric::DataInterface' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ParticleIterationStateBinding) == 0x000128, "Member 'UNiagaraSimulationStageGeneric::ParticleIterationStateBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ParticleIterationStateRange) == 0x000180, "Member 'UNiagaraSimulationStageGeneric::ParticleIterationStateRange' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, OverrideGpuDispatchNumThreads) == 0x00018C, "Member 'UNiagaraSimulationStageGeneric::OverrideGpuDispatchNumThreads' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, DirectDispatchType) == 0x000198, "Member 'UNiagaraSimulationStageGeneric::DirectDispatchType' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, DirectDispatchElementType) == 0x000199, "Member 'UNiagaraSimulationStageGeneric::DirectDispatchElementType' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ElementCountXBinding) == 0x0001A0, "Member 'UNiagaraSimulationStageGeneric::ElementCountXBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ElementCountYBinding) == 0x0001F8, "Member 'UNiagaraSimulationStageGeneric::ElementCountYBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ElementCountZBinding) == 0x000250, "Member 'UNiagaraSimulationStageGeneric::ElementCountZBinding' has a wrong offset!");

// Class Niagara.NiagaraSpriteRendererProperties
// 0x0A80 (0x0B60 - 0x00E0)
...
public:
	...
	struct FVector2D                              PivotInUVSpace;                                    // 0x0114(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MacroUVRadius;                                     // 0x011C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraSortMode                              SortMode;                                          // 0x0120(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_121[0x3];                                      // 0x0121(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              SubImageSize;                                      // 0x0124(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bSubImageBlend : 1;                                // 0x012C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRemoveHMDRollInVR : 1;                            // 0x012C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         Pad_12D[0x3];                                      // 0x012D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	ENiagaraRendererSortPrecision                 SortPrecision;                                     // 0x0130(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRendererGpuTranslucentLatency         GpuTranslucentLatency;                             // 0x0131(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRendererPixelCoverageMode             PixelCoverageMode;                                 // 0x0132(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_133[0x1];                                      // 0x0133(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PixelCoverageBlend;                                // 0x0134(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinFacingCameraBlendDistance;                      // 0x0138(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxFacingCameraBlendDistance;                      // 0x013C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEnableCameraDistanceCulling : 1;                  // 0x0140(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	struct FNiagaraVariableAttributeBinding       SpriteRotationBinding;                             // 0x0258(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteSizeBinding;                                 // 0x02B0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteFacingBinding;                               // 0x0308(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteAlignmentBinding;                            // 0x0360(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SubImageIndexBinding;                              // 0x03B8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterialBinding;                            // 0x0410(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial1Binding;                           // 0x0468(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial2Binding;                           // 0x04C0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial3Binding;                           // 0x0518(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CameraOffsetBinding;                               // 0x0570(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       UVScaleBinding;                                    // 0x05C8(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PivotOffsetBinding;                                // 0x0620(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x0678(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CustomSortingBinding;                              // 0x06D0(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x0728(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0780(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraRendererMaterialParameters     MaterialParameters;                                // 0x07D8(0x0050)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x0828(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevVelocityBinding;                               // 0x0880(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteRotationBinding;                         // 0x08D8(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteSizeBinding;                             // 0x0930(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteFacingBinding;                           // 0x0988(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteAlignmentBinding;                        // 0x09E0(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevCameraOffsetBinding;                           // 0x0A38(0x0058)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevPivotOffsetBinding;                            // 0x0A90(0x0058)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_AE8[0x78];                                     // 0x0AE8(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraSpriteRendererProperties) == 0x000B60, "Wrong size on UNiagaraSpriteRendererProperties");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotInUVSpace) == 0x000114, "Member 'UNiagaraSpriteRendererProperties::PivotInUVSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MacroUVRadius) == 0x00011C, "Member 'UNiagaraSpriteRendererProperties::MacroUVRadius' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SortMode) == 0x000120, "Member 'UNiagaraSpriteRendererProperties::SortMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageSize) == 0x000124, "Member 'UNiagaraSpriteRendererProperties::SubImageSize' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SortPrecision) == 0x000130, "Member 'UNiagaraSpriteRendererProperties::SortPrecision' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, GpuTranslucentLatency) == 0x000131, "Member 'UNiagaraSpriteRendererProperties::GpuTranslucentLatency' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PixelCoverageMode) == 0x000132, "Member 'UNiagaraSpriteRendererProperties::PixelCoverageMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PixelCoverageBlend) == 0x000134, "Member 'UNiagaraSpriteRendererProperties::PixelCoverageBlend' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MinFacingCameraBlendDistance) == 0x000138, "Member 'UNiagaraSpriteRendererProperties::MinFacingCameraBlendDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaxFacingCameraBlendDistance) == 0x00013C, "Member 'UNiagaraSpriteRendererProperties::MaxFacingCameraBlendDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MinCameraDistance) == 0x000144, "Member 'UNiagaraSpriteRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaxCameraDistance) == 0x000148, "Member 'UNiagaraSpriteRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibility) == 0x00014C, "Member 'UNiagaraSpriteRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PositionBinding) == 0x000150, "Member 'UNiagaraSpriteRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, ColorBinding) == 0x0001A8, "Member 'UNiagaraSpriteRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, VelocityBinding) == 0x000200, "Member 'UNiagaraSpriteRendererProperties::VelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteRotationBinding) == 0x000258, "Member 'UNiagaraSpriteRendererProperties::SpriteRotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteSizeBinding) == 0x0002B0, "Member 'UNiagaraSpriteRendererProperties::SpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteFacingBinding) == 0x000308, "Member 'UNiagaraSpriteRendererProperties::SpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteAlignmentBinding) == 0x000360, "Member 'UNiagaraSpriteRendererProperties::SpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageIndexBinding) == 0x0003B8, "Member 'UNiagaraSpriteRendererProperties::SubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterialBinding) == 0x000410, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial1Binding) == 0x000468, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial2Binding) == 0x0004C0, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial3Binding) == 0x000518, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CameraOffsetBinding) == 0x000570, "Member 'UNiagaraSpriteRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, UVScaleBinding) == 0x0005C8, "Member 'UNiagaraSpriteRendererProperties::UVScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotOffsetBinding) == 0x000620, "Member 'UNiagaraSpriteRendererProperties::PivotOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialRandomBinding) == 0x000678, "Member 'UNiagaraSpriteRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CustomSortingBinding) == 0x0006D0, "Member 'UNiagaraSpriteRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, NormalizedAgeBinding) == 0x000728, "Member 'UNiagaraSpriteRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibilityTagBinding) == 0x000780, "Member 'UNiagaraSpriteRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialParameters) == 0x0007D8, "Member 'UNiagaraSpriteRendererProperties::MaterialParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPositionBinding) == 0x000828, "Member 'UNiagaraSpriteRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevVelocityBinding) == 0x000880, "Member 'UNiagaraSpriteRendererProperties::PrevVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteRotationBinding) == 0x0008D8, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteRotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteSizeBinding) == 0x000930, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteFacingBinding) == 0x000988, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteAlignmentBinding) == 0x0009E0, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevCameraOffsetBinding) == 0x000A38, "Member 'UNiagaraSpriteRendererProperties::PrevCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPivotOffsetBinding) == 0x000A90, "Member 'UNiagaraSpriteRendererProperties::PrevPivotOffsetBinding' has a wrong offset!");
...
public:
	...
	bool                                          bDumpDebugSystemInfo;                              // 0x0060(0x0001)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDumpDebugEmitterInfo;                             // 0x0061(0x0001)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<struct FNiagaraSystemScalabilityOverride> ScalabilityOverrides;                              // 0x0078(0x0010)(ZeroConstructor, Deprecated, Protected, NativeAccessSpecifierProtected)
	struct FNiagaraSystemScalabilityOverrides     SystemScalabilityOverrides;                        // 0x0088(0x0010)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<struct FNiagaraEmitterHandle>          EmitterHandles;                                    // 0x0098(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<class UNiagaraParameterCollectionInstance*> ParameterCollectionOverrides;                      // 0x00A8(0x0010)(Edit, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UNiagaraScript*                         SystemSpawnScript;                                 // 0x00B8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNiagaraScript*                         SystemUpdateScript;                                // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C8[0x10];                                      // 0x00C8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraSystemCompiledData             SystemCompiledData;                                // 0x00D8(0x0240)(Protected, NativeAccessSpecifierProtected)
	...
	bool                                          bDeterminism;                                      // 0x040D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_40E[0x2];                                      // 0x040E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RandomSeed;                                        // 0x0410(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         WarmupTime;                                        // 0x0414(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         WarmupTickCount;                                   // 0x0418(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         WarmupTickDelta;                                   // 0x041C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bFixedTickDelta;                                   // 0x0420(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_421[0x3];                                      // 0x0421(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         FixedTickDeltaTime;                                // 0x0424(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHasSystemScriptDIsWithPerInstanceData;            // 0x0428(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bNeedsGPUContextInitForDataInterfaces;             // 0x0429(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_42A[0x6];                                      // 0x042A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           UserDINamesReadInSystemScripts;                    // 0x0430(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<class UNiagaraDataChannelDefinitions*> ReferencedDataChannelDefinitions;                  // 0x0440(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UNiagaraSystem) == 0x000500, "Wrong size on UNiagaraSystem");
...
static_assert(offsetof(UNiagaraSystem, ScalabilityOverrides) == 0x000078, "Member 'UNiagaraSystem::ScalabilityOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemScalabilityOverrides) == 0x000088, "Member 'UNiagaraSystem::SystemScalabilityOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, EmitterHandles) == 0x000098, "Member 'UNiagaraSystem::EmitterHandles' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ParameterCollectionOverrides) == 0x0000A8, "Member 'UNiagaraSystem::ParameterCollectionOverrides' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemSpawnScript) == 0x0000B8, "Member 'UNiagaraSystem::SystemSpawnScript' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemUpdateScript) == 0x0000C0, "Member 'UNiagaraSystem::SystemUpdateScript' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemCompiledData) == 0x0000D8, "Member 'UNiagaraSystem::SystemCompiledData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ExposedParameters) == 0x000318, "Member 'UNiagaraSystem::ExposedParameters' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSystem, bDeterminism) == 0x00040D, "Member 'UNiagaraSystem::bDeterminism' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, RandomSeed) == 0x000410, "Member 'UNiagaraSystem::RandomSeed' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTime) == 0x000414, "Member 'UNiagaraSystem::WarmupTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickCount) == 0x000418, "Member 'UNiagaraSystem::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickDelta) == 0x00041C, "Member 'UNiagaraSystem::WarmupTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bFixedTickDelta) == 0x000420, "Member 'UNiagaraSystem::bFixedTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, FixedTickDeltaTime) == 0x000424, "Member 'UNiagaraSystem::FixedTickDeltaTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bHasSystemScriptDIsWithPerInstanceData) == 0x000428, "Member 'UNiagaraSystem::bHasSystemScriptDIsWithPerInstanceData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bNeedsGPUContextInitForDataInterfaces) == 0x000429, "Member 'UNiagaraSystem::bNeedsGPUContextInitForDataInterfaces' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, UserDINamesReadInSystemScripts) == 0x000430, "Member 'UNiagaraSystem::UserDINamesReadInSystemScripts' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ReferencedDataChannelDefinitions) == 0x000440, "Member 'UNiagaraSystem::ReferencedDataChannelDefinitions' has a wrong offset!");
