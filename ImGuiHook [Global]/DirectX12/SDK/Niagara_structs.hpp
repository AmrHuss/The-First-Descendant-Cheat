...
static_assert(alignof(FNiagaraPositionSource) == 0x000004, "Wrong alignment on FNiagaraPositionSource");
static_assert(sizeof(FNiagaraPositionSource) == 0x000014, "Wrong size on FNiagaraPositionSource");
...
static_assert(offsetof(FNiagaraFunctionSignature, RequiredInputs) == 0x00003C, "Member 'FNiagaraFunctionSignature::RequiredInputs' has a wrong offset!");
static_assert(offsetof(FNiagaraFunctionSignature, RequiredOutputs) == 0x00003E, "Member 'FNiagaraFunctionSignature::RequiredOutputs' has a wrong offset!");
...
{
public:
	struct FBox                                   LocalBounds;                                       // 0x0000(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         TotalSpawnedParticles;                             // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraSimCacheDataBuffers            ParticleDataBuffers;                               // 0x0020(0x0060)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSimCacheEmitterFrame) == 0x000008, "Wrong alignment on FNiagaraSimCacheEmitterFrame");
static_assert(sizeof(FNiagaraSimCacheEmitterFrame) == 0x000080, "Wrong size on FNiagaraSimCacheEmitterFrame");
...
static_assert(offsetof(FNiagaraSimCacheEmitterFrame, TotalSpawnedParticles) == 0x00001C, "Member 'FNiagaraSimCacheEmitterFrame::TotalSpawnedParticles' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheEmitterFrame, ParticleDataBuffers) == 0x000020, "Member 'FNiagaraSimCacheEmitterFrame::ParticleDataBuffers' has a wrong offset!");
...
static_assert(sizeof(FNiagaraDataChannelReference) == 0x000008, "Wrong size on FNiagaraDataChannelReference");
...
static_assert(offsetof(FNiagaraParameterBinding, Parameter) == 0x000000, "Member 'FNiagaraParameterBinding::Parameter' has a wrong offset!");
...
{
public:
	int32                                         NumFrames;                                         // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CaptureRate;                                       // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNiagaraSimCacheCaptureParameters) == 0x000010, "Wrong size on FNiagaraSimCacheCaptureParameters");
static_assert(offsetof(FNiagaraSimCacheCaptureParameters, NumFrames) == 0x000000, "Member 'FNiagaraSimCacheCaptureParameters::NumFrames' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheCaptureParameters, CaptureRate) == 0x000004, "Member 'FNiagaraSimCacheCaptureParameters::CaptureRate' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheCaptureParameters, bManuallyAdvanceSimulation) == 0x000008, "Member 'FNiagaraSimCacheCaptureParameters::bManuallyAdvanceSimulation' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheCaptureParameters, AdvanceDeltaTime) == 0x00000C, "Member 'FNiagaraSimCacheCaptureParameters::AdvanceDeltaTime' has a wrong offset!");
...
public:
	...
	struct FNiagaraSimCacheDataBuffers            SystemDataBuffers;                                 // 0x0020(0x0060)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSimCacheSystemFrame) == 0x000008, "Wrong alignment on FNiagaraSimCacheSystemFrame");
static_assert(sizeof(FNiagaraSimCacheSystemFrame) == 0x000080, "Wrong size on FNiagaraSimCacheSystemFrame");
...
static_assert(offsetof(FNiagaraSimCacheSystemFrame, SystemDataBuffers) == 0x000020, "Member 'FNiagaraSimCacheSystemFrame::SystemDataBuffers' has a wrong offset!");
...
{
public:
	struct FTransform                             LocalToWorld;                                      // 0x0000(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector3f                              LWCTile;                                           // 0x0030(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SimulationAge;                                     // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraSimCacheSystemFrame            SystemData;                                        // 0x0040(0x0080)(NativeAccessSpecifierPublic)
	TArray<struct FNiagaraSimCacheEmitterFrame>   EmitterData;                                       // 0x00C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSimCacheFrame) == 0x000010, "Wrong alignment on FNiagaraSimCacheFrame");
static_assert(sizeof(FNiagaraSimCacheFrame) == 0x0000D0, "Wrong size on FNiagaraSimCacheFrame");
...
static_assert(offsetof(FNiagaraSimCacheFrame, LWCTile) == 0x000030, "Member 'FNiagaraSimCacheFrame::LWCTile' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheFrame, SimulationAge) == 0x00003C, "Member 'FNiagaraSimCacheFrame::SimulationAge' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheFrame, SystemData) == 0x000040, "Member 'FNiagaraSimCacheFrame::SystemData' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheFrame, EmitterData) == 0x0000C0, "Member 'FNiagaraSimCacheFrame::EmitterData' has a wrong offset!");
...
public:
	...
	struct FVector                                ViewportLocation;                                  // 0x0004(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               ViewportRotation;                                  // 0x0010(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         OrbitDistance;                                     // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FOV;                                               // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OrthoWidth;                                        // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseAspectRatio;                                   // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x3];                                       // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         AspectRatio;                                       // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraBakerCameraSettings) == 0x000004, "Wrong alignment on FNiagaraBakerCameraSettings");
static_assert(sizeof(FNiagaraBakerCameraSettings) == 0x000030, "Wrong size on FNiagaraBakerCameraSettings");
...
static_assert(offsetof(FNiagaraBakerCameraSettings, ViewportLocation) == 0x000004, "Member 'FNiagaraBakerCameraSettings::ViewportLocation' has a wrong offset!");
static_assert(offsetof(FNiagaraBakerCameraSettings, ViewportRotation) == 0x000010, "Member 'FNiagaraBakerCameraSettings::ViewportRotation' has a wrong offset!");
static_assert(offsetof(FNiagaraBakerCameraSettings, OrbitDistance) == 0x00001C, "Member 'FNiagaraBakerCameraSettings::OrbitDistance' has a wrong offset!");
static_assert(offsetof(FNiagaraBakerCameraSettings, FOV) == 0x000020, "Member 'FNiagaraBakerCameraSettings::FOV' has a wrong offset!");
static_assert(offsetof(FNiagaraBakerCameraSettings, OrthoWidth) == 0x000024, "Member 'FNiagaraBakerCameraSettings::OrthoWidth' has a wrong offset!");
static_assert(offsetof(FNiagaraBakerCameraSettings, bUseAspectRatio) == 0x000028, "Member 'FNiagaraBakerCameraSettings::bUseAspectRatio' has a wrong offset!");
static_assert(offsetof(FNiagaraBakerCameraSettings, AspectRatio) == 0x00002C, "Member 'FNiagaraBakerCameraSettings::AspectRatio' has a wrong offset!");
...
public:
	...
	struct FVector2D                              OverviewLocation;                                  // 0x0010(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowRegisteredComponents;                         // 0x0018(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverviewShowFilteredSystemOnly;                   // 0x0019(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ENiagaraDebugHudVerbosity                     DataInterfaceVerbosity;                            // 0x0084(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSystemShowBounds;                                 // 0x0088(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_89[0x3];                                       // 0x0089(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SystemBoundsSolidBoxAlpha;                         // 0x008C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSystemShowActiveOnlyInWorld;                      // 0x0090(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowSystemVariables;                              // 0x0091(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FNiagaraDebugHudTextOptions            SystemTextOptions;                                 // 0x00A8(0x0010)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	...
	bool                                          bShowParticleIndex;                                // 0x00BA(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FNiagaraDebugHudTextOptions            ParticleTextOptions;                               // 0x00D0(0x0010)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FVector2D                              ParticleDisplayClip;                               // 0x00E4(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseParticleDisplayCenterRadius;                   // 0x00EC(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_ED[0x3];                                       // 0x00ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ParticleDisplayCenterRadius;                       // 0x00F0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxParticlesToDisplay;                             // 0x00F4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PerfReportFrames;                                  // 0x00F8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraDebugHUDPerfSampleMode                PerfSampleMode;                                    // 0x00FC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraDebugHUDPerfGraphMode                 PerfGraphMode;                                     // 0x0100(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PerfHistoryFrames;                                 // 0x0104(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PerfGraphTimeRange;                                // 0x0108(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              PerfGraphSize;                                     // 0x010C(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           PerfGraphAxisColor;                                // 0x0114(0x0010)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableSmoothing;                                  // 0x0124(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_125[0x3];                                      // 0x0125(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         SmoothingWidth;                                    // 0x0128(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           DefaultBackgroundColor;                            // 0x012C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           OverviewHeadingColor;                              // 0x013C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           OverviewDetailColor;                               // 0x014C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           OverviewDetailHighlightColor;                      // 0x015C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           InWorldErrorTextColor;                             // 0x016C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           InWorldTextColor;                                  // 0x017C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           MessageInfoTextColor;                              // 0x018C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           MessageWarningTextColor;                           // 0x019C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           MessageErrorTextColor;                             // 0x01AC(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SystemColorTableOpacity;                           // 0x01BC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        SystemColorSeed;                                   // 0x01C0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SystemColorHSVMin;                                 // 0x01C4(0x000C)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SystemColorHSVMax;                                 // 0x01D0(0x000C)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraDebugPlaybackMode                     PlaybackMode;                                      // 0x01DC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPlaybackRateEnabled;                              // 0x01DD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DE[0x2];                                      // 0x01DE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PlaybackRate;                                      // 0x01E0(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLoopTimeEnabled;                                  // 0x01E4(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E5[0x3];                                      // 0x01E5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         LoopTime;                                          // 0x01E8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowGlobalBudgetInfo;                             // 0x01EC(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNiagaraDebugHUDSettingsData) == 0x0001F0, "Wrong size on FNiagaraDebugHUDSettingsData");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowRegisteredComponents) == 0x000018, "Member 'FNiagaraDebugHUDSettingsData::bShowRegisteredComponents' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bOverviewShowFilteredSystemOnly) == 0x000019, "Member 'FNiagaraDebugHUDSettingsData::bOverviewShowFilteredSystemOnly' has a wrong offset!");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, DataInterfaceVerbosity) == 0x000084, "Member 'FNiagaraDebugHUDSettingsData::DataInterfaceVerbosity' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bSystemShowBounds) == 0x000088, "Member 'FNiagaraDebugHUDSettingsData::bSystemShowBounds' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemBoundsSolidBoxAlpha) == 0x00008C, "Member 'FNiagaraDebugHUDSettingsData::SystemBoundsSolidBoxAlpha' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bSystemShowActiveOnlyInWorld) == 0x000090, "Member 'FNiagaraDebugHUDSettingsData::bSystemShowActiveOnlyInWorld' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowSystemVariables) == 0x000091, "Member 'FNiagaraDebugHUDSettingsData::bShowSystemVariables' has a wrong offset!");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowParticleIndex) == 0x0000BA, "Member 'FNiagaraDebugHUDSettingsData::bShowParticleIndex' has a wrong offset!");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleDisplayClip) == 0x0000E4, "Member 'FNiagaraDebugHUDSettingsData::ParticleDisplayClip' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseParticleDisplayCenterRadius) == 0x0000EC, "Member 'FNiagaraDebugHUDSettingsData::bUseParticleDisplayCenterRadius' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleDisplayCenterRadius) == 0x0000F0, "Member 'FNiagaraDebugHUDSettingsData::ParticleDisplayCenterRadius' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MaxParticlesToDisplay) == 0x0000F4, "Member 'FNiagaraDebugHUDSettingsData::MaxParticlesToDisplay' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfReportFrames) == 0x0000F8, "Member 'FNiagaraDebugHUDSettingsData::PerfReportFrames' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfSampleMode) == 0x0000FC, "Member 'FNiagaraDebugHUDSettingsData::PerfSampleMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphMode) == 0x000100, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfHistoryFrames) == 0x000104, "Member 'FNiagaraDebugHUDSettingsData::PerfHistoryFrames' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphTimeRange) == 0x000108, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphTimeRange' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphSize) == 0x00010C, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphSize' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphAxisColor) == 0x000114, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphAxisColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bEnableSmoothing) == 0x000124, "Member 'FNiagaraDebugHUDSettingsData::bEnableSmoothing' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SmoothingWidth) == 0x000128, "Member 'FNiagaraDebugHUDSettingsData::SmoothingWidth' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, DefaultBackgroundColor) == 0x00012C, "Member 'FNiagaraDebugHUDSettingsData::DefaultBackgroundColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewHeadingColor) == 0x00013C, "Member 'FNiagaraDebugHUDSettingsData::OverviewHeadingColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewDetailColor) == 0x00014C, "Member 'FNiagaraDebugHUDSettingsData::OverviewDetailColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewDetailHighlightColor) == 0x00015C, "Member 'FNiagaraDebugHUDSettingsData::OverviewDetailHighlightColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, InWorldErrorTextColor) == 0x00016C, "Member 'FNiagaraDebugHUDSettingsData::InWorldErrorTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, InWorldTextColor) == 0x00017C, "Member 'FNiagaraDebugHUDSettingsData::InWorldTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageInfoTextColor) == 0x00018C, "Member 'FNiagaraDebugHUDSettingsData::MessageInfoTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageWarningTextColor) == 0x00019C, "Member 'FNiagaraDebugHUDSettingsData::MessageWarningTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageErrorTextColor) == 0x0001AC, "Member 'FNiagaraDebugHUDSettingsData::MessageErrorTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorTableOpacity) == 0x0001BC, "Member 'FNiagaraDebugHUDSettingsData::SystemColorTableOpacity' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorSeed) == 0x0001C0, "Member 'FNiagaraDebugHUDSettingsData::SystemColorSeed' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorHSVMin) == 0x0001C4, "Member 'FNiagaraDebugHUDSettingsData::SystemColorHSVMin' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorHSVMax) == 0x0001D0, "Member 'FNiagaraDebugHUDSettingsData::SystemColorHSVMax' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackMode) == 0x0001DC, "Member 'FNiagaraDebugHUDSettingsData::PlaybackMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bPlaybackRateEnabled) == 0x0001DD, "Member 'FNiagaraDebugHUDSettingsData::bPlaybackRateEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackRate) == 0x0001E0, "Member 'FNiagaraDebugHUDSettingsData::PlaybackRate' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bLoopTimeEnabled) == 0x0001E4, "Member 'FNiagaraDebugHUDSettingsData::bLoopTimeEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, LoopTime) == 0x0001E8, "Member 'FNiagaraDebugHUDSettingsData::LoopTime' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowGlobalBudgetInfo) == 0x0001EC, "Member 'FNiagaraDebugHUDSettingsData::bShowGlobalBudgetInfo' has a wrong offset!");
...
public:
	...
	struct FBox                                   FixedBounds;                                       // 0x0048(0x001C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         bRequiresPersistentIDs : 1;                        // 0x0064(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCombineEventSpawn : 1;                            // 0x0064(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_65[0x3];                                       // 0x0065(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FNiagaraEventScriptProperties>  EventHandlerScriptProps;                           // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x0078(0x0030)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraEmitterScalabilityOverrides    ScalabilityOverrides;                              // 0x00A8(0x0010)(Edit, NativeAccessSpecifierPublic)
	uint8                                         bLimitDeltaTime : 1;                               // 0x00B8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_B9[0x3];                                       // 0x00B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxGPUParticlesSpawnPerFrame;                      // 0x00BC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxDeltaTimePerTick;                               // 0x00C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EParticleAllocationMode                       AllocationMode;                                    // 0x00C4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C5[0x3];                                       // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PreAllocationCount;                                // 0x00C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_CC[0x4];                                       // 0x00CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraEmitterScriptProperties        UpdateScriptProps;                                 // 0x00D0(0x0028)(NativeAccessSpecifierPublic)
	struct FNiagaraEmitterScriptProperties        SpawnScriptProps;                                  // 0x00F8(0x0028)(NativeAccessSpecifierPublic)
	struct FNiagaraParameterStore                 RendererBindings;                                  // 0x0120(0x0088)(NativeAccessSpecifierPublic)
	TArray<class UNiagaraRendererProperties*>     RendererProperties;                                // 0x01A8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraSimulationStageBase*>    SimulationStages;                                  // 0x01B8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UNiagaraScript*                         GPUComputeScript;                                  // 0x01C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FName>                           SharedEventGeneratorIds;                           // 0x01D0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FNiagaraEmitterScalabilitySettings     CurrentScalabilitySettings;                        // 0x01E0(0x0038)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FVersionedNiagaraEmitterData) == 0x0002C8, "Wrong size on FVersionedNiagaraEmitterData");
...
static_assert(offsetof(FVersionedNiagaraEmitterData, EventHandlerScriptProps) == 0x000068, "Member 'FVersionedNiagaraEmitterData::EventHandlerScriptProps' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, Platforms) == 0x000078, "Member 'FVersionedNiagaraEmitterData::Platforms' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, ScalabilityOverrides) == 0x0000A8, "Member 'FVersionedNiagaraEmitterData::ScalabilityOverrides' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, MaxGPUParticlesSpawnPerFrame) == 0x0000BC, "Member 'FVersionedNiagaraEmitterData::MaxGPUParticlesSpawnPerFrame' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, MaxDeltaTimePerTick) == 0x0000C0, "Member 'FVersionedNiagaraEmitterData::MaxDeltaTimePerTick' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, AllocationMode) == 0x0000C4, "Member 'FVersionedNiagaraEmitterData::AllocationMode' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, PreAllocationCount) == 0x0000C8, "Member 'FVersionedNiagaraEmitterData::PreAllocationCount' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, UpdateScriptProps) == 0x0000D0, "Member 'FVersionedNiagaraEmitterData::UpdateScriptProps' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SpawnScriptProps) == 0x0000F8, "Member 'FVersionedNiagaraEmitterData::SpawnScriptProps' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, RendererBindings) == 0x000120, "Member 'FVersionedNiagaraEmitterData::RendererBindings' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, RendererProperties) == 0x0001A8, "Member 'FVersionedNiagaraEmitterData::RendererProperties' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SimulationStages) == 0x0001B8, "Member 'FVersionedNiagaraEmitterData::SimulationStages' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, GPUComputeScript) == 0x0001C8, "Member 'FVersionedNiagaraEmitterData::GPUComputeScript' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SharedEventGeneratorIds) == 0x0001D0, "Member 'FVersionedNiagaraEmitterData::SharedEventGeneratorIds' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, CurrentScalabilitySettings) == 0x0001E0, "Member 'FVersionedNiagaraEmitterData::CurrentScalabilitySettings' has a wrong offset!");
...
public:
	...
	int32                                         LODLevel;                                          // 0x0018(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LODBias;                                           // 0x001C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FVector                                Scale;                                             // 0x0030(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               Rotation;                                          // 0x003C(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                PivotOffset;                                       // 0x0048(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraMeshPivotOffsetSpace                  PivotOffsetSpace;                                  // 0x0054(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_55[0x3];                                       // 0x0055(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, Rotation) == 0x00003C, "Member 'FNiagaraMeshRendererMeshProperties::Rotation' has a wrong offset!");
...
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, PivotOffsetSpace) == 0x000054, "Member 'FNiagaraMeshRendererMeshProperties::PivotOffsetSpace' has a wrong offset!");
