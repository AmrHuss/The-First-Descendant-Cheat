...
static_assert(sizeof(USteamNetConnection) == 0x001E50, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001E48, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
...
static_assert(sizeof(USteamNetDriver) == 0x000870, "Wrong size on USteamNetDriver");
