...
{
public:
	uint8                                         Pad_50[0x200];                                     // 0x0050(0x0200)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UReplicationGraphNode_GridSpatialization2D) == 0x000250, "Wrong size on UReplicationGraphNode_GridSpatialization2D");
...
static_assert(sizeof(UNetReplicationGraphConnection) == 0x000370, "Wrong size on UNetReplicationGraphConnection");
...
static_assert(offsetof(UNetReplicationGraphConnection, ConnectionGraphNodes) == 0x000238, "Member 'UNetReplicationGraphConnection::ConnectionGraphNodes' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, TearOffNode) == 0x000248, "Member 'UNetReplicationGraphConnection::TearOffNode' has a wrong offset!");
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x0248(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x0250(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AReplicationGraphDebugActor) == 0x000258, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x000248, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x000250, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
