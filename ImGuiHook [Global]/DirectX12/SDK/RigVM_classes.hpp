...
static_assert(sizeof(URigVMHost) == 0x000180, "Wrong size on URigVMHost");
...
static_assert(offsetof(URigVMHost, DrawContainer) == 0x000060, "Member 'URigVMHost::DrawContainer' has a wrong offset!");
static_assert(offsetof(URigVMHost, EventQueue) == 0x000090, "Member 'URigVMHost::EventQueue' has a wrong offset!");
static_assert(offsetof(URigVMHost, AssetUserData) == 0x000130, "Member 'URigVMHost::AssetUserData' has a wrong offset!");
...
static_assert(alignof(URigVMBlueprintGeneratedClass) == 0x000010, "Wrong alignment on URigVMBlueprintGeneratedClass");
...
static_assert(sizeof(URigVM) == 0x0003F0, "Wrong size on URigVM");
...
static_assert(offsetof(URigVM, Instructions) == 0x0000F8, "Member 'URigVM::Instructions' has a wrong offset!");
static_assert(offsetof(URigVM, Context) == 0x000108, "Member 'URigVM::Context' has a wrong offset!");
static_assert(offsetof(URigVM, NumExecutions) == 0x000210, "Member 'URigVM::NumExecutions' has a wrong offset!");
static_assert(offsetof(URigVM, FunctionNamesStorage) == 0x000218, "Member 'URigVM::FunctionNamesStorage' has a wrong offset!");
static_assert(offsetof(URigVM, Parameters) == 0x000260, "Member 'URigVM::Parameters' has a wrong offset!");
static_assert(offsetof(URigVM, ParametersNameMap) == 0x000270, "Member 'URigVM::ParametersNameMap' has a wrong offset!");
static_assert(offsetof(URigVM, DeferredVMToCopy) == 0x0003A8, "Member 'URigVM::DeferredVMToCopy' has a wrong offset!");
...
static_assert(sizeof(URigVMMemoryStorageGeneratorClass) == 0x000250, "Wrong size on URigVMMemoryStorageGeneratorClass");
...
static_assert(sizeof(URigVMNativized) == 0x000418, "Wrong size on URigVMNativized");
