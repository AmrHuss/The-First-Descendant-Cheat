...
static_assert(alignof(USE_Viessa_PassiveEpicBoss03_C) == 0x000008, "Wrong alignment on USE_Viessa_PassiveEpicBoss03_C");
static_assert(sizeof(USE_Viessa_PassiveEpicBoss03_C) == 0x0003B8, "Wrong size on USE_Viessa_PassiveEpicBoss03_C");
static_assert(offsetof(USE_Viessa_PassiveEpicBoss03_C, UberGraphFrame_SE_Viessa_PassiveEpicBoss03_C) == 0x0003A8, "Member 'USE_Viessa_PassiveEpicBoss03_C::UberGraphFrame_SE_Viessa_PassiveEpicBoss03_C' has a wrong offset!");
static_assert(offsetof(USE_Viessa_PassiveEpicBoss03_C, Rate) == 0x0003B0, "Member 'USE_Viessa_PassiveEpicBoss03_C::Rate' has a wrong offset!");
