...
public:
	...
	struct FQuat                                  Quat;                                              // 0x0070(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FVector2D                              Vector2D;                                          // 0x000C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FMatrix                                Matrix;                                            // 0x0030(0x0040)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FPlane                                 Plane;                                             // 0x0070(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FQuat                                  Quat;                                              // 0x0080(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               Rotator;                                           // 0x0090(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Transform;                                         // 0x00A0(0x0030)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBox                                   Box;                                               // 0x00D0(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FBox2D                                 Box2D;                                             // 0x00EC(0x0014)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FBoxSphereBounds                       BoxSphereBounds;                                   // 0x0100(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FOrientedBox                           OrientedBox;                                       // 0x011C(0x003C)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	TArray<struct FVector>                        VectorArray;                                       // 0x0168(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FString, struct FVector>           StrToVec;                                          // 0x0178(0x0050)(NativeAccessSpecifierPublic)
	TSet<struct FVector>                          VectorSet;                                         // 0x01C8(0x0050)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(FStructSerializerLWCTypesTest) == 0x000220, "Wrong size on FStructSerializerLWCTypesTest");
...
static_assert(offsetof(FStructSerializerLWCTypesTest, Vector2D) == 0x00000C, "Member 'FStructSerializerLWCTypesTest::Vector2D' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Vector4) == 0x000020, "Member 'FStructSerializerLWCTypesTest::Vector4' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Matrix) == 0x000030, "Member 'FStructSerializerLWCTypesTest::Matrix' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Plane) == 0x000070, "Member 'FStructSerializerLWCTypesTest::Plane' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Quat) == 0x000080, "Member 'FStructSerializerLWCTypesTest::Quat' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Rotator) == 0x000090, "Member 'FStructSerializerLWCTypesTest::Rotator' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Transform) == 0x0000A0, "Member 'FStructSerializerLWCTypesTest::Transform' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Box) == 0x0000D0, "Member 'FStructSerializerLWCTypesTest::Box' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Box2D) == 0x0000EC, "Member 'FStructSerializerLWCTypesTest::Box2D' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, BoxSphereBounds) == 0x000100, "Member 'FStructSerializerLWCTypesTest::BoxSphereBounds' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, OrientedBox) == 0x00011C, "Member 'FStructSerializerLWCTypesTest::OrientedBox' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Float) == 0x000158, "Member 'FStructSerializerLWCTypesTest::Float' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, Double) == 0x000160, "Member 'FStructSerializerLWCTypesTest::Double' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, VectorArray) == 0x000168, "Member 'FStructSerializerLWCTypesTest::VectorArray' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, StrToVec) == 0x000178, "Member 'FStructSerializerLWCTypesTest::StrToVec' has a wrong offset!");
static_assert(offsetof(FStructSerializerLWCTypesTest, VectorSet) == 0x0001C8, "Member 'FStructSerializerLWCTypesTest::VectorSet' has a wrong offset!");
...
public:
	...
	struct FStructSerializerBuiltinTestStruct     Builtins;                                          // 0x0110(0x0090)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FStructSerializerLWCTypesTest          LWCTypes;                                          // 0x0480(0x0220)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FStructSerializerTestStruct) == 0x000010, "Wrong alignment on FStructSerializerTestStruct");
static_assert(sizeof(FStructSerializerTestStruct) == 0x0006A0, "Wrong size on FStructSerializerTestStruct");
...
static_assert(offsetof(FStructSerializerTestStruct, LWCTypes) == 0x000480, "Member 'FStructSerializerTestStruct::LWCTypes' has a wrong offset!");
