...
public:
	...
	struct FStyleColorList                        ActiveColors;                                      // 0x0038(0x09B0)(Edit, Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USlateThemeManager) == 0x0009E8, "Wrong size on USlateThemeManager");
