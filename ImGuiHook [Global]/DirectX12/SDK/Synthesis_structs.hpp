...
public:
	...
	struct FVector2D                              ModulationInputRange;                              // 0x0004(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              ModulationOutputMinimumRange;                      // 0x000C(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              ModulationOutputMaximumRange;                      // 0x0014(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         UpdateEaseMS;                                      // 0x001C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSourceEffectMotionFilterModulationSettings) == 0x000004, "Wrong alignment on FSourceEffectMotionFilterModulationSettings");
static_assert(sizeof(FSourceEffectMotionFilterModulationSettings) == 0x000020, "Wrong size on FSourceEffectMotionFilterModulationSettings");
...
static_assert(offsetof(FSourceEffectMotionFilterModulationSettings, ModulationInputRange) == 0x000004, "Member 'FSourceEffectMotionFilterModulationSettings::ModulationInputRange' has a wrong offset!");
static_assert(offsetof(FSourceEffectMotionFilterModulationSettings, ModulationOutputMinimumRange) == 0x00000C, "Member 'FSourceEffectMotionFilterModulationSettings::ModulationOutputMinimumRange' has a wrong offset!");
static_assert(offsetof(FSourceEffectMotionFilterModulationSettings, ModulationOutputMaximumRange) == 0x000014, "Member 'FSourceEffectMotionFilterModulationSettings::ModulationOutputMaximumRange' has a wrong offset!");
static_assert(offsetof(FSourceEffectMotionFilterModulationSettings, UpdateEaseMS) == 0x00001C, "Member 'FSourceEffectMotionFilterModulationSettings::UpdateEaseMS' has a wrong offset!");
