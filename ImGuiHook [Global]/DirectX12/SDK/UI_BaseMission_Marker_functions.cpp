...
#include "UI_BaseMission_Marker_classes.hpp"
#include "UI_BaseMission_Marker_parameters.hpp"
...
void UUI_BaseMission_Marker_C::ExecuteUbergraph_UI_BaseMission_Marker(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_BaseMission_Marker_C", "ExecuteUbergraph_UI_BaseMission_Marker");

	Params::UI_BaseMission_Marker_C_ExecuteUbergraph_UI_BaseMission_Marker Parms{};
...
void UUI_BaseMission_Marker_C::SetUIState(bool IsDim)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_BaseMission_Marker_C", "SetUIState");
