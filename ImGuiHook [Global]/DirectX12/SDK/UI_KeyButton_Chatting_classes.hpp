...
static_assert(alignof(UUI_KeyButton_Chatting_C) == 0x000008, "Wrong alignment on UUI_KeyButton_Chatting_C");
static_assert(sizeof(UUI_KeyButton_Chatting_C) == 0x000908, "Wrong size on UUI_KeyButton_Chatting_C");
static_assert(offsetof(UUI_KeyButton_Chatting_C, UberGraphFrame) == 0x0008F0, "Member 'UUI_KeyButton_Chatting_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UUI_KeyButton_Chatting_C, Panel_SizeBox) == 0x0008F8, "Member 'UUI_KeyButton_Chatting_C::Panel_SizeBox' has a wrong offset!");
static_assert(offsetof(UUI_KeyButton_Chatting_C, bShowText) == 0x000900, "Member 'UUI_KeyButton_Chatting_C::bShowText' has a wrong offset!");
