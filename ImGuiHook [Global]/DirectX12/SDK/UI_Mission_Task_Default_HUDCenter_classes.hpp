...
static_assert(alignof(UUI_Mission_Task_Default_HUDCenter_C) == 0x000008, "Wrong alignment on UUI_Mission_Task_Default_HUDCenter_C");
static_assert(sizeof(UUI_Mission_Task_Default_HUDCenter_C) == 0x000720, "Wrong size on UUI_Mission_Task_Default_HUDCenter_C");
static_assert(offsetof(UUI_Mission_Task_Default_HUDCenter_C, UberGraphFrame) == 0x000710, "Member 'UUI_Mission_Task_Default_HUDCenter_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UUI_Mission_Task_Default_HUDCenter_C, UIAnim_Open) == 0x000718, "Member 'UUI_Mission_Task_Default_HUDCenter_C::UIAnim_Open' has a wrong offset!");
