...
static_assert(alignof(UUI_Mission_Task_Goal_Invasion_C) == 0x000008, "Wrong alignment on UUI_Mission_Task_Goal_Invasion_C");
static_assert(sizeof(UUI_Mission_Task_Goal_Invasion_C) == 0x000720, "Wrong size on UUI_Mission_Task_Goal_Invasion_C");
static_assert(offsetof(UUI_Mission_Task_Goal_Invasion_C, UI_Mission_Task_TargetNameTag) == 0x000718, "Member 'UUI_Mission_Task_Goal_Invasion_C::UI_Mission_Task_TargetNameTag' has a wrong offset!");
