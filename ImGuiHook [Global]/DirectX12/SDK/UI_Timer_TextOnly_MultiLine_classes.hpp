...
static_assert(alignof(UUI_Timer_TextOnly_MultiLine_C) == 0x000010, "Wrong alignment on UUI_Timer_TextOnly_MultiLine_C");
static_assert(sizeof(UUI_Timer_TextOnly_MultiLine_C) == 0x000A70, "Wrong size on UUI_Timer_TextOnly_MultiLine_C");
static_assert(offsetof(UUI_Timer_TextOnly_MultiLine_C, UberGraphFrame) == 0x000758, "Member 'UUI_Timer_TextOnly_MultiLine_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UUI_Timer_TextOnly_MultiLine_C, TextStyle) == 0x000760, "Member 'UUI_Timer_TextOnly_MultiLine_C::TextStyle' has a wrong offset!");
