...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bInIgnoreCulling                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidget::SetIgnoreCulling(bool bInIgnoreCulling)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Widget", "SetIgnoreCulling");

	Params::Widget_SetIgnoreCulling Parms{};

	Parms.bInIgnoreCulling = bInIgnoreCulling;
...
bool UWidget::GetIgnoreCulling() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Widget", "GetIgnoreCulling");

	Params::Widget_GetIgnoreCulling Parms{};
...
bool UWidget::IsCulledInLastFrame() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Widget", "IsCulledInLastFrame");

	Params::Widget_IsCulledInLastFrame Parms{};
...
bool UUserWidget::IsAnimationPlayingForward(const class UWidgetAnimation* InAnimation) const
{
	static class UFunction* Func = nullptr;
