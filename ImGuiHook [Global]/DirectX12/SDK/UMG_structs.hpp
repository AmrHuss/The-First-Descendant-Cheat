...
static_assert(alignof(FGameViewportWidgetSlot) == 0x000004, "Wrong alignment on FGameViewportWidgetSlot");
static_assert(sizeof(FGameViewportWidgetSlot) == 0x00002C, "Wrong size on FGameViewportWidgetSlot");
...
static_assert(offsetof(FGameViewportWidgetSlot, Offsets) == 0x000010, "Member 'FGameViewportWidgetSlot::Offsets' has a wrong offset!");
static_assert(offsetof(FGameViewportWidgetSlot, Alignment) == 0x000020, "Member 'FGameViewportWidgetSlot::Alignment' has a wrong offset!");
static_assert(offsetof(FGameViewportWidgetSlot, ZOrder) == 0x000028, "Member 'FGameViewportWidgetSlot::ZOrder' has a wrong offset!");
