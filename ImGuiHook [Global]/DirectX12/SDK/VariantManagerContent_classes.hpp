...
{
public:
	struct FSoftObjectPath                        LevelVariantSets;                                  // 0x0248(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<TSubclassOf<class UObject>, class ULevelVariantSetsFunctionDirector*> DirectorInstances;                                 // 0x0268(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ALevelVariantSetsActor) == 0x0002B8, "Wrong size on ALevelVariantSetsActor");
...
static_assert(offsetof(ALevelVariantSetsActor, DirectorInstances) == 0x000268, "Member 'ALevelVariantSetsActor::DirectorInstances' has a wrong offset!");
...
public:
	...
	class USceneComponent*                        SceneComponent;                                    // 0x0260(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
