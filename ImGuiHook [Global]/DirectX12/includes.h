...
const SDK::FLinearColor ColorWhite = { 1.0f, 1.0f, 1.0f, 1.0f };
const SDK::FLinearColor ColorRed = { 1.0f, 0, 0, 1.0f };
const SDK::FLinearColor ColorDarkRed = { 0.5f, 0.0f, 0.0f, 0.8f };
const SDK::FLinearColor ColorGreen = { 0, 1.0f, 0, 1.0f };
const SDK::FLinearColor ColorMana = { 0.184f, 0.702f, 1.0f, 1.0f };

const SDK::FLinearColor ColorCommon = { 0, 0.922f, 0.29f, 1.0f };
const SDK::FLinearColor ColorUncommon = { 0.2f, 0.29f, 1.0f, 1.0f };
const SDK::FLinearColor ColorRare = { 0.761f, 0.063f, 0.961, 1.0f };
const SDK::FLinearColor ColorUltimate = { 1.0f, 0.247f, 0.247f, 1.0f };

const SDK::FLinearColor ColorGold = { 1.0f, 0.882f, 0, 1.0f };
...
SDK::TArray<SDK::FTransform>* BoneArrayPointer = nullptr;
/*
*   Player Enemy ESP
*/
void PlayerEnemyESP();
